...
open SyntaxEng, (S=SyntaxEng), (E=ExtraEng), (L=TestLexiconEng), (P=ParadigmsEng), ConstructionEng, Prelude in {
	...
	lin t81_Looks_like_we_still_need_to_train_more_outdoors = (mkText (mkUtt (mkS (mkCl (mkVP (passiveVP L.look_V2) (S.mkAdv S.that_Subj (mkS (mkCl S.we_NP (mkVP (P.mkAdV "still") (mkVP L.need_VV (mkVP (mkVP (P.mkAdV "more") (mkVP L.train_V)) L.outdoors_Adv)))))))))) fullStopPunct) ;
