...
public class Tester {
    ...
    public void t01_girls_see_a_boy() {
        ...
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.girl_N)) (mkVP L.see_V2 (mkNP S.a_Quant (mkCN L.boy_N)))))) fullStopPunct)");
    ...
    public void t03_two_girls_see_a_boy() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkNum (mkDigits \"2\")) (mkCN L.girl_N)) (mkVP L.see_V2 (mkNP S.a_Quant (mkCN L.boy_N)))))) fullStopPunct)");
    ...
    public void t04_two_pretty_girls_see_a_boy() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkNum (mkDigits \"2\")) (mkCN (mkAP L.pretty_A) L.girl_N)) (mkVP L.see_V2 (mkNP S.a_Quant (mkCN L.boy_N)))))) fullStopPunct)");
    ...
    public void t05_the_boy_sees_the_two_pretty_girls() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.boy_N)) (mkVP L.see_V2 (mkNP S.a_Quant (mkNum (mkDigits \"2\")) (mkCN (mkAP L.pretty_A) L.girl_N)))))) fullStopPunct)");
    ...
    public void t06_girls_and_boys_play_a_game() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.and_Conj (mkListNP (mkNP S.a_Quant (mkCN L.girl_N)) (mkNP S.a_Quant (mkCN L.boy_N)))) (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N)))))) fullStopPunct)");
    ...
    public void t07_boys_girls_and_a_dog_play_a_game() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.and_Conj (mkListNP (mkNP S.a_Quant (mkCN L.dog_N)) (mkListNP (mkNP S.a_Quant (mkCN L.boy_N)) (mkNP S.a_Quant (mkCN L.girl_N))))) (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N)))))) fullStopPunct)");
    ...
    public void t08_many_persons_live() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.many_Det (mkCN L.person_N)) (mkVP L.live_V)))) fullStopPunct)");
    ...
    public void t09_some_persons_live_in_Ventspils() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.somePl_Det (mkCN L.person_N)) (mkVP (mkVP L.live_V) (S.mkAdv L.in_Prep (mkNP (P.mkPN \"Ventspils\"))))))) fullStopPunct)");
    ...
    public void t10_many_persons_live_in_Riga() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.many_Det (mkCN L.person_N)) (mkVP (mkVP L.live_V) (S.mkAdv L.in_Prep (mkNP (P.mkPN \"Riga\"))))))) fullStopPunct)");
    ...
    public void t11_more_persons_live_in_New_York() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP L.more_Det (mkCN L.person_N)) (mkVP (mkVP L.live_V) (S.mkAdv L.in_Prep (mkNP (P.mkPN \"New York\"))))))) fullStopPunct)");
    ...
    public void t13_few_persons_live_in_Riga_and_New_York() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.few_Det (mkCN L.person_N)) (mkVP (mkVP L.live_V) (S.mkAdv L.in_Prep (mkNP S.and_Conj (mkListNP (mkNP (P.mkPN \"Riga\")) (mkNP (P.mkPN \"New York\"))))))))) fullStopPunct)");
    ...
    public void t14_boys_and_girls_play_games_in_Riga() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.and_Conj (mkListNP (mkNP S.a_Quant (mkCN L.boy_N)) (mkNP S.a_Quant (mkCN L.girl_N)))) (mkVP (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N))) (S.mkAdv L.in_Prep (mkNP (P.mkPN \"Riga\"))))))) fullStopPunct)");
    ...
    public void t15_boys_and_girls_play_games_in_Riga_and_New_York() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.and_Conj (mkListNP (mkNP S.a_Quant (mkCN L.boy_N)) (mkNP S.a_Quant (mkCN L.girl_N)))) (mkVP (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N))) (S.mkAdv L.in_Prep (mkNP S.and_Conj (mkListNP (mkNP (P.mkPN \"Riga\")) (mkNP (P.mkPN \"New York\"))))))))) fullStopPunct)");
    ...
    public void t16_boys_see_Ann() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.boy_N)) (mkVP L.see_V2 (mkNP (P.mkPN \"Ann\")))))) fullStopPunct)");
    ...
    public void t17_John_plays_a_game() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"John\")) (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N)))))) fullStopPunct)");
    ...
    public void t18_John_sees_Ann() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"John\")) (mkVP L.see_V2 (mkNP (P.mkPN \"Ann\")))))) fullStopPunct)");
    ...
    public void t19_girls_see_some_boys_who_play_a_game() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.girl_N)) (mkVP L.see_V2 (mkNP S.somePl_Det (mkCN (mkCN L.boy_N) (mkRS (mkRCl S.which_RP (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.game_N))))))))))) fullStopPunct)");
    ...
    public void t20_girls_see_some_pretty_boys_who_play_a_ball_game() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.girl_N)) (mkVP L.see_V2 (mkNP S.somePl_Det (mkCN (mkCN (mkAP L.pretty_A) L.boy_N) (mkRS (mkRCl S.which_RP (mkVP L.play_V2 (mkNP S.a_Quant (mkCN L.ball_A L.game_N))))))))))) fullStopPunct)");
    ...
    public void t21_girls_who_see_the_game_like_the_boys_who_play() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN (mkCN L.girl_N) (mkRS (mkRCl S.which_RP (mkVP L.see_V2 (mkNP S.a_Quant (mkCN L.game_N))))))) (mkVP L.like_V2 (mkNP S.a_Quant (mkCN (mkCN L.boy_N) (mkRS (mkRCl S.which_RP (mkVP L.play_V))))))))) fullStopPunct)");

        generateBody(Thread.currentThread().getStackTrace()[1].getMethodName(), ast, true);
    }

    // Assad spoke about the city.
    // TODO: "Assad gave a speech about the city.": give-01 vs. speak-01 / speech vs. speak-01
    // (CAMR?)
    ...
    public void t22_Assad_spoke_about_the_city() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Assad\")) (mkVP (mkVP L.speak_V) (S.mkAdv L.about_Prep (mkNP S.a_Quant (mkCN L.city_N))))))) fullStopPunct)");
    ...
    public void t23_Assad_spoke_about_the_two_cities() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Assad\")) (mkVP (mkVP L.speak_V) (S.mkAdv L.about_Prep (mkNP S.a_Quant (mkNum (mkDigits \"2\")) (mkCN L.city_N))))))) fullStopPunct)");
    ...
    public void t24_Assad_spoke_a_word_about_the_city() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Assad\")) (mkVP L.speak_V2 (mkNP S.a_Quant (mkCN (mkCN L.word_N) (S.mkAdv L.about_Prep (mkNP S.a_Quant (mkCN L.city_N))))))))) fullStopPunct)");
    ...
    public void t25_the_boy_is_a_person() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN L.boy_N)) (mkNP S.a_Quant (mkCN L.person_N))))) fullStopPunct)");
    ...
    public void t26_Iceland_is_a_very_interesting_example() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Iceland\")) (mkNP S.a_Quant (mkCN (mkCN L.example_N) (mkRS (mkRCl S.which_RP (mkAP L.very_AdA (mkAP L.interest_A))))))))) fullStopPunct)");
    ...
    public void t27_they_are_thugs_and_deserve_a_bullet() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS S.and_Conj (mkListS (mkS (mkCl S.they_NP (mkNP S.a_Quant (mkCN L.thug_N)))) (mkS (mkCl (mkVP L.deserve_V2 (mkNP S.a_Quant (mkCN L.bullet_N)))))))) fullStopPunct)");
    ...
    public void t28_China_president_urges_child_safety() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (mkCN (P.mkN2 L.president_N L.of_Prep) (mkNP (P.mkPN \"China\")))) (mkVP L.urge_VV (mkVP L.protect_V2 (mkNP S.a_Quant (mkCN L.child_N))))))) fullStopPunct)");
    ...
    public void t29_French_far_left_killer_leaves_jail() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN (mkCN (mkCN L.far_A (mkCN L.left_A L.person_N)) (S.mkAdv L.from_Prep (mkNP (P.mkPN \"France\")))) (mkRS (mkRCl S.which_RP (mkVP L.kill_V))))) (mkVP L.leave_V2 (mkNP S.a_Quant (mkCN L.jail_N)))))) fullStopPunct)");
    ...
    public void t30_two_other_school_assailants_have_committed_suicide() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkNum (mkDigits \"2\")) (mkCN (mkCN L.other_A L.person_N) (mkRS (mkRCl S.which_RP (mkVP L.assail_V2 (mkNP S.a_Quant (mkCN L.school_N))))))) (mkVP L.commit_V2 (mkNP S.a_Quant (mkCN L.suicide_N)))))) fullStopPunct)");
    ...
    public void t31_Gadhafi_attacks_US_in_speech_in_Italy() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Gadhafi\")) (mkVP (mkVP L.attack_V2 (mkNP (P.mkPN \"US\"))) (S.mkAdv S.when_Subj (mkS (mkCl (mkVP (mkVP L.speak_V) (S.mkAdv L.in_Prep (mkNP (P.mkPN \"Italy\"))))))))))) fullStopPunct)");
    ...
    public void t32_we_must_look_at_their_reasons() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl S.we_NP (mkVP (passiveVP L.obligate_V2) (E.PurposeVP (mkVP L.look_V2 (mkNP S.they_Pron (mkCN L.reason_N)))))))) fullStopPunct)");
    ...
    public void t33_the_man_Xu_Yuyuan_wielded_a_knife_usually_used_to_slaughter_pigs() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (P.mkPN \"Xu Yuyuan\")) (mkVP L.wield_V2 (mkNP S.a_Quant (mkCN (mkCN L.knife_N) (mkRS (mkRCl S.which_RP (mkVP (mkVP (P.mkAdV \"usually\") (passiveVP L.use_V2)) (E.PurposeVP (mkVP L.slaughter_V2 (mkNP S.a_Quant (mkCN L.pig_N))))))))))))) fullStopPunct)");
    ...
    public void t34_Libyan_Abdel_Basset_Ali_al_Megrahi_was_convicted_of_blowing_up_the_plane() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (mkNP (P.mkPN \"Abdel Basset Ali al-Megrahi\")) (S.mkAdv L.from_Prep (mkNP (P.mkPN \"Libya\")))) (mkVP (passiveVP L.convict_V2) (E.PurposeVP (mkVP L.blow_up_V2 (mkNP S.a_Quant (mkCN L.plane_N)))))))) fullStopPunct)");
    ...
    public void t35_a_fourth_member_Jean_Marc_Rouillan_remains_behind_bars() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP (mkNP (P.mkPN \"Jean-Marc Rouillan\")) (mkRS (mkRCl S.which_RP (mkNP (mkDet S.the_Quant (S.mkOrd (mkDigits \"4\"))) (mkCN (P.mkN2 L.member_N L.of_Prep)))))) (mkVP (passiveVP L.remain_V2) (S.mkAdv L.behind_Prep (mkNP S.a_Quant (mkCN L.bar_N))))))) fullStopPunct)");
    ...
    public void t36_I_d_never_heard_of_this_case_until_now() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS negativePol (mkCl S.i_NP (mkVP (mkVP L.hear_V2 (mkNP S.this_Det (mkCN L.case_N))) (S.mkAdv L.until_Prep (mkNP L.now_N)))))) fullStopPunct)");
    ...
    public void t37_so_I_googled_it_to_get_more_information() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl S.i_NP (mkVP (mkVP L.google_V2 S.it_NP) (E.PurposeVP (mkVP L.get_V2 (mkNP L.more_Det (mkCN L.information_N)))))))) fullStopPunct)");
    ...
    public void t38_even_the_information_that_is_available_is_fuzzy() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN (mkCN L.information_N) (mkRS (mkRCl S.which_RP (mkAP L.available_A))))) (mkAP L.even_AdA (mkAP L.fuzzy_A))))) fullStopPunct)");
    ...
    public void t39_as_for_the_race_angle_it_is_unnecessary() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS negativePol (mkCl (mkNP S.a_Quant (mkCN L.race_A L.angle_N)) (passiveVP L.need_V2)))) fullStopPunct)");
    ...
    public void t40_it_s_a_horrible_thing_that_happened() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkNP S.a_Quant (mkCN L.horrible_A L.thing_N))))");
    ...
    public void t41_you_are_an_idiot() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl S.you_NP (mkNP S.a_Quant (mkCN L.idiot_N))))) fullStopPunct)");

        generateBody(Thread.currentThread().getStackTrace()[1].getMethodName(), ast, false);
    }

    // ::snt They need to throw these punks in jail!
    // TODO: reconstruct missing prepositions, depending on frame/verb, argument role (e.g.
    // GOL_Prep) and/or the head of the NP.
    // TODO: consider statistics from PropBank and FrameNet corpora (clearly dominant
    // verb/frame-specific prepositions vs. NP-specific cases).
    ...
    public void t42_they_need_to_throw_these_punks_in_jail() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl S.they_NP (mkVP (passiveVP L.obligate_V2) (E.PurposeVP (mkVP (mkVP L.throw_V2 (mkNP S.this_Det (mkCN L.punk_N))) (S.mkAdv L.GOL_Prep (mkNP S.a_Quant (mkCN L.jail_N))))))))) fullStopPunct)");
    ...
    public void t43_they_should_have_been_expelled_from_school_at_a_minimum() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkVP (passiveVP L.recommend_V2) (S.mkAdv S.that_Subj (mkS (mkCl S.they_NP (mkVP (mkVP (passiveVP L.expel_V2) (S.mkAdv L.DIR_Prep (mkNP S.a_Quant (mkCN L.school_N)))) (P.mkAdv \"at a minimum\"))))))))) fullStopPunct)");
    ...
    public void t44_my_opinion_is_based_on_the_information_provided() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl (mkNP S.a_Quant (mkCN (mkCN L.thing_N) (mkRS (mkRCl S.which_RP S.i_NP L.opine_V2)))) (mkVP (passiveVP L.base_V2) (S.mkAdv L.DIR_Prep (mkNP S.a_Quant (mkCN (mkCN L.information_N) (mkRS (mkRCl S.which_RP (passiveVP L.provide_V2)))))))))) fullStopPunct)");

        generateBody(Thread.currentThread().getStackTrace()[1].getMethodName(), ast, false);
    }

    // ::snt Texas criminal courts and prosecutors do not coddle to anyone.
    // TODO: 'person that prosecutes' => prosecutor (t29: 'person that kills' => killer; t50:
    // 'person that perpetrates' => perpetrator)
    ...
    public void t46_I_don_t_think_it_is_a_race_issue_either() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS (mkCl S.i_NP (mkVP (P.mkAdV \"either\") (mkVP L.think_VS (mkS negativePol (mkCl S.it_NP (mkNP S.a_Quant (mkCN L.race_A L.issue_N))))))))) fullStopPunct)");
    ...
    public void t47_the_girl_is_very_nice_and_the_boy_is_very_good() {
        ...
        String ast = t.transformToGF(amr).get(0);
        assertEquals(ast, "(mkText (mkUtt (mkS S.and_Conj (mkListS (mkS (mkCl (mkNP S.a_Quant (mkCN L.girl_N)) (mkAP L.very_AdA (mkAP L.nice_A)))) (mkS (mkCl (mkNP S.a_Quant (mkCN L.boy_N)) (mkAP L.very_AdA (mkAP L.good_A))))))) fullStopPunct)");
