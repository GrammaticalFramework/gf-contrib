...
/**
 * A PEG grammar for parsing and rewriting AMR representations, so that they are compliant with the
 * LISP-like bracketing tree syntax.
 */
...
public class AMRGrammar extends BaseParser<AMRNode> {
    ...
    // ROOT = Instance
    public Rule Root() {
        return Sequence(push(new AMRNode("ROOT")), Instance(), EOI);
    }
