...
instance Print (Tree c) where
  prt _i e = case e of
    ...
    RSelect cond rel -> prPrec _i 2 (concatD [doc (showString "\\sigma_{") , prt 0 cond , doc (showString "}") , prt 3 rel])
    RProject projections rel -> prPrec _i 2 (concatD [doc (showString "\\pi_{") , prt 0 projections , doc (showString "}") , prt 3 rel])
    RRename renaming rel -> prPrec _i 2 (concatD [doc (showString "\\rho_{") , prt 0 renaming , doc (showString "}") , prt 3 rel])
    RGroup is aggregations rel -> prPrec _i 2 (concatD [doc (showString "\\gamma_{") , prt 0 is , doc (showString ",") , prt 0 aggregations , doc (showString "}") , prt 3 rel])
    RSort exps rel -> prPrec _i 2 (concatD [doc (showString "\\tau_{") , prt 0 exps , doc (showString "}") , prt 3 rel])
    RDistinct rel -> prPrec _i 2 (concatD [doc (showString "\\delta") , prt 3 rel])
    RUnion rel0 rel1 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "\\cup") , prt 2 rel1])
    RJoin rel0 rel1 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "\\bowtie") , prt 2 rel1])
    ...
    EAggr function i -> prPrec _i 3 (concatD [prt 0 function , doc (showString "(") , prt 0 i , doc (showString ")")])
    ...
    AApp function i -> prPrec _i 0 (concatD [prt 0 function , doc (showString "(") , prt 0 i , doc (showString ")")])
    ARename function i exp -> prPrec _i 0 (concatD [prt 0 function , doc (showString "(") , prt 0 i , doc (showString ")") , doc (showString "\\rightarrow") , prt 0 exp])
