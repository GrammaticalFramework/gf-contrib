...
instance Print (Tree c) where
  prt _i e = case e of
    ...
    RSelect cond rel -> prPrec _i 2 (concatD [doc (showString "FILTER") , doc (showString "[") , prt 0 cond , doc (showString "]") , prt 2 rel])
    RProject projections rel -> prPrec _i 2 (concatD [doc (showString "PROJECT") , doc (showString "[") , prt 0 projections , doc (showString "]") , prt 2 rel])
    RRename renaming rel -> prPrec _i 2 (concatD [doc (showString "RENAME") , doc (showString "[") , prt 0 renaming , doc (showString "]") , prt 2 rel])
    RGroup is aggregations rel -> prPrec _i 2 (concatD [doc (showString "GROUP") , doc (showString "[") , prt 0 is , doc (showString ",") , prt 0 aggregations , doc (showString "]") , prt 2 rel])
    RSort sortexps rel -> prPrec _i 2 (concatD [doc (showString "ORDER") , doc (showString "[") , prt 0 sortexps , doc (showString "]") , prt 2 rel])
    RDistinct rel -> prPrec _i 2 (concatD [doc (showString "DISTINCT") , prt 2 rel])
    ...
    RThetaJoin rel0 cond1 rel2 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "JOIN") , doc (showString "[") , prt 0 cond1 , doc (showString "]") , prt 2 rel2])
    RInnerJoin rel0 is1 rel2 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "INNER") , doc (showString "JOIN") , doc (showString "[") , prt 0 is1 , doc (showString "]") , prt 2 rel2])
    RFullOuterJoin rel0 is1 rel2 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "FULL") , doc (showString "OUTER") , doc (showString "JOIN") , doc (showString "[") , prt 0 is1 , doc (showString "]") , prt 2 rel2])
    RLeftOuterJoin rel0 is1 rel2 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "LEFT") , doc (showString "OUTER") , doc (showString "JOIN") , doc (showString "[") , prt 0 is1 , doc (showString "]") , prt 2 rel2])
    RRightOuterJoin rel0 is1 rel2 -> prPrec _i 1 (concatD [prt 1 rel0 , doc (showString "RIGHT") , doc (showString "OUTER") , doc (showString "JOIN") , doc (showString "[") , prt 0 is1 , doc (showString "]") , prt 2 rel2])
