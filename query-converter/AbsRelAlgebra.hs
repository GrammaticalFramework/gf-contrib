...
instance Compos Tree where
  compos r a f t = case t of
      ...
      RTable ident -> r RTable `a` f ident
      ...
      RGroup idents aggregations rel -> r RGroup `a` foldr (a . a (r (:)) . f) (r []) idents `a` foldr (a . a (r (:)) . f) (r []) aggregations `a` f rel
      ...
      RInnerJoin rel0 idents1 rel2 -> r RInnerJoin `a` f rel0 `a` foldr (a . a (r (:)) . f) (r []) idents1 `a` f rel2
      RFullOuterJoin rel0 idents1 rel2 -> r RFullOuterJoin `a` f rel0 `a` foldr (a . a (r (:)) . f) (r []) idents1 `a` f rel2
      RLeftOuterJoin rel0 idents1 rel2 -> r RLeftOuterJoin `a` f rel0 `a` foldr (a . a (r (:)) . f) (r []) idents1 `a` f rel2
      RRightOuterJoin rel0 idents1 rel2 -> r RRightOuterJoin `a` f rel0 `a` foldr (a . a (r (:)) . f) (r []) idents1 `a` f rel2
      RLet ident rel0 rel1 -> r RLet `a` f ident `a` f rel0 `a` f rel1
      ...
      EIdent ident -> r EIdent `a` f ident
      EQIdent ident0 ident1 -> r EQIdent `a` f ident0 `a` f ident1
      EAggr function distinct ident -> r EAggr `a` f function `a` f distinct `a` f ident
      ...
      PRename exp ident -> r PRename `a` f exp `a` f ident
      RRelation ident -> r RRelation `a` f ident
      RAttributes ident idents -> r RAttributes `a` f ident `a` foldr (a . a (r (:)) . f) (r []) idents
      AApp function distinct ident -> r AApp `a` f function `a` f distinct `a` f ident
      ARename function distinct ident exp -> r ARename `a` f function `a` f distinct `a` f ident `a` f exp
...
instance Show (Tree c) where
  showsPrec n t = case t of
    ...
    RTable ident -> opar n . showString "RTable" . showChar ' ' . showsPrec 1 ident . cpar n
    ...
    RGroup idents aggregations rel -> opar n . showString "RGroup" . showChar ' ' . showsPrec 1 idents . showChar ' ' . showsPrec 1 aggregations . showChar ' ' . showsPrec 1 rel . cpar n
    ...
    RInnerJoin rel0 idents1 rel2 -> opar n . showString "RInnerJoin" . showChar ' ' . showsPrec 1 rel0 . showChar ' ' . showsPrec 1 idents1 . showChar ' ' . showsPrec 1 rel2 . cpar n
    RFullOuterJoin rel0 idents1 rel2 -> opar n . showString "RFullOuterJoin" . showChar ' ' . showsPrec 1 rel0 . showChar ' ' . showsPrec 1 idents1 . showChar ' ' . showsPrec 1 rel2 . cpar n
    RLeftOuterJoin rel0 idents1 rel2 -> opar n . showString "RLeftOuterJoin" . showChar ' ' . showsPrec 1 rel0 . showChar ' ' . showsPrec 1 idents1 . showChar ' ' . showsPrec 1 rel2 . cpar n
    RRightOuterJoin rel0 idents1 rel2 -> opar n . showString "RRightOuterJoin" . showChar ' ' . showsPrec 1 rel0 . showChar ' ' . showsPrec 1 idents1 . showChar ' ' . showsPrec 1 rel2 . cpar n
    RLet ident rel0 rel1 -> opar n . showString "RLet" . showChar ' ' . showsPrec 1 ident . showChar ' ' . showsPrec 1 rel0 . showChar ' ' . showsPrec 1 rel1 . cpar n
    ...
    EIdent ident -> opar n . showString "EIdent" . showChar ' ' . showsPrec 1 ident . cpar n
    EQIdent ident0 ident1 -> opar n . showString "EQIdent" . showChar ' ' . showsPrec 1 ident0 . showChar ' ' . showsPrec 1 ident1 . cpar n
    ...
    EFloat double -> opar n . showString "EFloat" . showChar ' ' . showsPrec 1 double . cpar n
    EAggr function distinct ident -> opar n . showString "EAggr" . showChar ' ' . showsPrec 1 function . showChar ' ' . showsPrec 1 distinct . showChar ' ' . showsPrec 1 ident . cpar n
    ...
    PRename exp ident -> opar n . showString "PRename" . showChar ' ' . showsPrec 1 exp . showChar ' ' . showsPrec 1 ident . cpar n
    RRelation ident -> opar n . showString "RRelation" . showChar ' ' . showsPrec 1 ident . cpar n
    RAttributes ident idents -> opar n . showString "RAttributes" . showChar ' ' . showsPrec 1 ident . showChar ' ' . showsPrec 1 idents . cpar n
    AApp function distinct ident -> opar n . showString "AApp" . showChar ' ' . showsPrec 1 function . showChar ' ' . showsPrec 1 distinct . showChar ' ' . showsPrec 1 ident . cpar n
    ARename function distinct ident exp -> opar n . showString "ARename" . showChar ' ' . showsPrec 1 function . showChar ' ' . showsPrec 1 distinct . showChar ' ' . showsPrec 1 ident . showChar ' ' . showsPrec 1 exp . cpar n
...
johnMajorEq (RTable ident) (RTable ident_) = ident == ident_
...
johnMajorEq (RGroup idents aggregations rel) (RGroup idents_ aggregations_ rel_) = idents == idents_ && aggregations == aggregations_ && rel == rel_
...
johnMajorEq (RInnerJoin rel0 idents1 rel2) (RInnerJoin rel0_ idents1_ rel2_) = rel0 == rel0_ && idents1 == idents1_ && rel2 == rel2_
johnMajorEq (RFullOuterJoin rel0 idents1 rel2) (RFullOuterJoin rel0_ idents1_ rel2_) = rel0 == rel0_ && idents1 == idents1_ && rel2 == rel2_
johnMajorEq (RLeftOuterJoin rel0 idents1 rel2) (RLeftOuterJoin rel0_ idents1_ rel2_) = rel0 == rel0_ && idents1 == idents1_ && rel2 == rel2_
johnMajorEq (RRightOuterJoin rel0 idents1 rel2) (RRightOuterJoin rel0_ idents1_ rel2_) = rel0 == rel0_ && idents1 == idents1_ && rel2 == rel2_
johnMajorEq (RLet ident rel0 rel1) (RLet ident_ rel0_ rel1_) = ident == ident_ && rel0 == rel0_ && rel1 == rel1_
...
johnMajorEq (EIdent ident) (EIdent ident_) = ident == ident_
johnMajorEq (EQIdent ident0 ident1) (EQIdent ident0_ ident1_) = ident0 == ident0_ && ident1 == ident1_
johnMajorEq (EString string) (EString string_) = string == string_
johnMajorEq (EInt integer) (EInt integer_) = integer == integer_
johnMajorEq (EFloat double) (EFloat double_) = double == double_
johnMajorEq (EAggr function distinct ident) (EAggr function_ distinct_ ident_) = function == function_ && distinct == distinct_ && ident == ident_
...
johnMajorEq (PRename exp ident) (PRename exp_ ident_) = exp == exp_ && ident == ident_
johnMajorEq (RRelation ident) (RRelation ident_) = ident == ident_
johnMajorEq (RAttributes ident idents) (RAttributes ident_ idents_) = ident == ident_ && idents == idents_
johnMajorEq (AApp function distinct ident) (AApp function_ distinct_ ident_) = function == function_ && distinct == distinct_ && ident == ident_
johnMajorEq (ARename function distinct ident exp) (ARename function_ distinct_ ident_ exp_) = function == function_ && distinct == distinct_ && ident == ident_ && exp == exp_
...
compareSame (RTable ident) (RTable ident_) = compare ident ident_
...
compareSame (RGroup idents aggregations rel) (RGroup idents_ aggregations_ rel_) = mappend (compare idents idents_) (mappend (compare aggregations aggregations_) (compare rel rel_))
...
compareSame (RInnerJoin rel0 idents1 rel2) (RInnerJoin rel0_ idents1_ rel2_) = mappend (compare rel0 rel0_) (mappend (compare idents1 idents1_) (compare rel2 rel2_))
compareSame (RFullOuterJoin rel0 idents1 rel2) (RFullOuterJoin rel0_ idents1_ rel2_) = mappend (compare rel0 rel0_) (mappend (compare idents1 idents1_) (compare rel2 rel2_))
compareSame (RLeftOuterJoin rel0 idents1 rel2) (RLeftOuterJoin rel0_ idents1_ rel2_) = mappend (compare rel0 rel0_) (mappend (compare idents1 idents1_) (compare rel2 rel2_))
compareSame (RRightOuterJoin rel0 idents1 rel2) (RRightOuterJoin rel0_ idents1_ rel2_) = mappend (compare rel0 rel0_) (mappend (compare idents1 idents1_) (compare rel2 rel2_))
compareSame (RLet ident rel0 rel1) (RLet ident_ rel0_ rel1_) = mappend (compare ident ident_) (mappend (compare rel0 rel0_) (compare rel1 rel1_))
...
compareSame (EIdent ident) (EIdent ident_) = compare ident ident_
compareSame (EQIdent ident0 ident1) (EQIdent ident0_ ident1_) = mappend (compare ident0 ident0_) (compare ident1 ident1_)
...
compareSame (EFloat double) (EFloat double_) = compare double double_
compareSame (EAggr function distinct ident) (EAggr function_ distinct_ ident_) = mappend (compare function function_) (mappend (compare distinct distinct_) (compare ident ident_))
...
compareSame (PRename exp ident) (PRename exp_ ident_) = mappend (compare exp exp_) (compare ident ident_)
compareSame (RRelation ident) (RRelation ident_) = compare ident ident_
compareSame (RAttributes ident idents) (RAttributes ident_ idents_) = mappend (compare ident ident_) (compare idents idents_)
compareSame (AApp function distinct ident) (AApp function_ distinct_ ident_) = mappend (compare function function_) (mappend (compare distinct distinct_) (compare ident ident_))
compareSame (ARename function distinct ident exp) (ARename function_ distinct_ ident_ exp_) = mappend (compare function function_) (mappend (compare distinct distinct_) (mappend (compare ident ident_) (compare exp exp_)))
