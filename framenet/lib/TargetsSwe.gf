concrete TargetsSwe of TargetsSweAbs = CatSwe ** open ParadigmsSwe, IrregSwe, StructuralSwe in {
	...
	lin
		...
		glömma_V2_Abandonment = mkV2 (mkV "glömmer") ;
		lämna_V2_Abandonment = mkV2 (mkV "lämnar") ;
		...
		sjuda_V_Absorb_heat = mkV "sjuda" "sjöd" "sjudit" ;
		...
		uppfinna_V2_Achieving_first = mkV2 (mkV "uppfinna" "uppfann" "uppfunnit") ;
		...
		-- No target for Activity_pause

		bereda_V_Activity_prepare = mkV "bereda" "beredde" "berett" ;
		förbereda_V_Activity_prepare = mkV "förbereda" "förberedde" "förberett" ;
		...
		ge_VV_Activity_start = mkVV (mkV "ge" "ger" "ge" "gav" "gett" "given") ;
		komma_VV_Activity_start = mkVV (mkV "komma" "kom" "kommit") ;
		uppta_V2_Activity_start = mkV2 (mkV "uppta" "upptar" "uppta" "upptog" "upptagit" "upptagen") ;

		avsluta_V2_Activity_stop = mkV2 (mkV "avslutar") ;
		lägga_V2_Activity_stop = mkV2 (mkV "lägga" "lade" "lagt") ;
		stoppa_V2_Activity_stop = mkV2 (mkV "stoppar") ;
		ställa_V2_Activity_stop = mkV2 (mkV "ställer") ;
		inhibera_V2_Activity_stop = mkV2 (mkV "inhiberar") ;
		seponera_V2_Activity_stop = mkV2 (mkV "seponerar") ;
		utsätta_V2_Activity_stop = mkV2 (mkV "utsätta" "utsätter" "utsätt" "utsatte" "utsatt" "utsatt") ;

		lägga_V2_Adding_up = mkV2 (mkV "lägga" "lade" "lagt") ;
		räkna_V2_Adding_up = mkV2 (mkV "räknar") ;
		...
		ställa_V_Adjusting = mkV "ställer" ;
		ställa_V2_Adjusting = mkV2 (mkV "ställer") ;
		...
		avböja_VV_Agree_or_refuse_to_act = mkVV (mkV "avböja" "avböjde" "avböjt") ;
		vägra_VV_Agree_or_refuse_to_act = mkVV (mkV "vägrar") ;
		...
		-- No target for Amounting_to

		baka_V2_Apply_heat = mkV2 (mkV "bakar") ;
		koka_V2_Apply_heat = mkV2 (mkV "kokar") ;
		pochera_V2_Apply_heat = mkV2 (mkV "pocherar") ;
		sjuda_V2_Apply_heat = mkV2 (mkV "sjuda" "sjöd" "sjudit") ;
		steka_V2_Apply_heat = mkV2 (mkV "steker") ;
		ångkoka_V2_Apply_heat = mkV2 (mkV "ångkokar") ;

		ackreditera_V2_Appointing = mkV2 (mkV "ackrediterar") ;

		arrangera_V2_Arranging = mkV2 (mkV "arrangerar") ;
		göra_V2_Arranging = mkV2 (mkV "göra" "gjorde" "gjort") ;
		lägga_V2_Arranging = mkV2 (mkV "lägga" "lade" "lagt") ;

		anlända_V_Arriving = mkV "anländer" ;
		komma_V_Arriving = mkV "komma" "kom" "kommit" ;
		landa_V_Arriving = mkV "landar" ;
		smita_V_Arriving = mkV "smita" "smet" "smitit" ;
		...
		stödja_V2_Assistance = mkV2 (mkV "stöda" "stödde" "stött") ;
		...
		bränna_V2_Attaching = mkV2 (mkV "bränna" "brände" "bränt") ;
		fästa_V2_Attaching = mkV2 (mkV "fästa" "fäster" "fäst" "fäste" "fäst" "fäst") ;
		förtöja_V2_Attaching = mkV2 (mkV "förtöja" "förtöjde" "förtöjt") ;
		haka_V2_Attaching = mkV2 (mkV "hakar") ;
		montera_V2_Attaching = mkV2 (mkV "monterar") ;
		spika_V2_Attaching = mkV2 (mkV "spikar") ;
		säkra_V2_Attaching = mkV2 (mkV "säkrar") ;
		koppla_V2_Attaching = mkV2 (mkV "kopplar") ;
		slå_V2_Attaching = mkV2 (mkV "slå" "slog" "slagit") ;

		angripa_V2_Attack = mkV2 (mkV "angripa" "angrep" "angripit") ;
		ge_V2_Attack = mkV2 (mkV "ge" "ger" "ge" "gav" "gett" "given") ;

		anstränga_V_Attempt = mkV "anstränger" ;
		bjuda_V_Attempt = mkV "bjuda" "bjöd" "bjudit" ;
		anstränga_VV_Attempt = mkVV (mkV "anstränger") ;
		...
		ana_V2_Awareness = mkV2 (mkV "anar") ;
		känna_V2_Awareness = mkV2 (mkV "känna" "kände" "känt") ;
		tro_VS_Awareness = mkVS (mkV "tror") ;
		föreställa_VV_Awareness = mkVV (mkV "föreställer") ;

		få_V_Be_in_agreement_on_assessment = mkV "få" "fick" "fått" ;

		klå_V2_Beat_opponent = mkV2 (mkV "klår") ;
		slå_V2_Beat_opponent = mkV2 (mkV "slå" "slog" "slagit") ;
		spöa_V2_Beat_opponent = mkV2 (mkV "spöar") ;
		ta_V2_Beat_opponent = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;

		hålla_V_Become_silent = mkV "hålla" "höll" "hållit" ;
		tiga_V_Become_silent = mkV "tiga" "teg" "tigit" ;

		göra_V_Becoming = mkV "göra" "gjorde" "gjort" ;
		utfalla_V_Becoming = mkV "utfalla" "utföll" "utfallit" ;

		ansluta_V_Becoming_a_member = mkV "ansluta" "anslöt" "anslutit" ;
		...
		torka_V_Becoming_dry = mkV "torkar" ;

		dela_V_Becoming_separated = mkV "delar" ;
		...
		producera_V2_Behind_the_scenes = mkV2 (mkV "producerar") ;

		hålla_V_Being_attached = mkV "hålla" "höll" "hållit" ;
		...
		vara_V_Being_located = mkV "varar" ;

		belägra_V2_Besieging = mkV2 (mkV "belägrar") ;
		inringa_V2_Besieging = mkV2 (mkV "inringar") ;
		...
		göra_V_Bragging = mkV "göra" "gjorde" "gjort" ;
		skryta_V_Bragging = mkV "skryta" "skröt" "skrutit" ;

		inhalera_V2_Breathing = mkV2 (mkV "inhalerar") ;

		bära_V2_Bringing = mkV2 (mkV "bära" "bar" "burit") ;
		...
		göra_V2_Causation = mkV2 (mkV "göra" "gjorde" "gjort") ;
		framkalla_V2_Causation = mkV2 (mkV "framkallar") ;
		förorsaka_V2_Causation = mkV2 (mkV "förorsakar") ;
		orsaka_V2_Causation = mkV2 (mkV "orsakar") ;
		utlösa_V2_Causation = mkV2 (mkV "utlöser") ;
		få_V2V_Causation = mkV2V (mkV "få" "fick" "fått") ;
		komma_V2V_Causation = mkV2V (mkV "komma" "kom" "kommit") ;

		förändra_V2_Cause_change = mkV2 (mkV "förändrar") ;
		göra_V2_Cause_change = mkV2 (mkV "göra" "gjorde" "gjort") ;
		...
		reda_V2_Cause_change_of_consistency = mkV2 (mkV "reda" "redde" "rett") ;
		mjuka_V2_Cause_change_of_consistency = mkV2 (mkV "mjukar") ;

		smälta_V2_Cause_change_of_phase = mkV2 (mkV "smälta" "smalt" "smultit") ;
		...
		försvaga_V2_Cause_change_of_strength = mkV2 (mkV "försvagar") ;
		...
		smäda_V2_Cause_emotion = mkV2 (mkV "smädar") ;

		droppa_V2_Cause_fluidic_motion = mkV2 (mkV "droppar") ;
		skvalpa_V2_Cause_fluidic_motion = mkV2 (mkV "skvalpar") ;
		slå_V2_Cause_fluidic_motion = mkV2 (mkV "slå" "slog" "slagit") ;
		strila_V2_Cause_fluidic_motion = mkV2 (mkV "strilar") ;
		tappa_V2_Cause_fluidic_motion = mkV2 (mkV "tappar") ;

		hugga_V_Cause_harm = mkV "hugga" "högg" "huggit" ;
		daska_V2_Cause_harm = mkV2 (mkV "daskar") ;
		golva_V2_Cause_harm = mkV2 (mkV "golvar") ;
		hugga_V2_Cause_harm = mkV2 (mkV "hugga" "högg" "huggit") ;
		klå_V2_Cause_harm = mkV2 (mkV "klår") ;
		knäa_V2_Cause_harm = mkV2 (mkV "knäar") ;
		slå_V2_Cause_harm = mkV2 (mkV "slå" "slog" "slagit") ;
		smocka_V2_Cause_harm = mkV2 (mkV "smockar") ;
		sparka_V2_Cause_harm = mkV2 (mkV "sparkar") ;
		spöa_V2_Cause_harm = mkV2 (mkV "spöar") ;

		banka_V_Cause_impact = mkV "bankar" ;
		drämma_V2_Cause_impact = mkV2 (mkV "drämmer") ;
		slå_V2_Cause_impact = mkV2 (mkV "slå" "slog" "slagit") ;
		daska_V2_Cause_impact = mkV2 (mkV "daskar") ;
		...
		skjuta_V2_Cause_motion = mkV2 (mkV "skjuta" "sköt" "skjutit") ;
		släpa_V2_Cause_motion = mkV2 (mkV "släpar") ;
		bogsera_V2_Cause_motion = mkV2 (mkV "bogserar") ;
		fira_V2_Cause_motion = mkV2 (mkV "firar") ;
		kasta_V2_Cause_motion = mkV2 (mkV "kastar") ;
		...
		bunta_V2_Cause_to_amalgamate = mkV2 (mkV "buntar") ;

		föna_V2_Cause_to_be_dry = mkV2 (mkV "fönar") ;
		hässja_V2_Cause_to_be_dry = mkV2 (mkV "hässjar") ;
		torka_V2_Cause_to_be_dry = mkV2 (mkV "torkar") ;
		...
		vässa_V2_Cause_to_be_sharp = mkV2 (mkV "vässar") ;
		...
		bryta_V2_Cause_to_end = mkV2 (mkV "bryta" "bröt" "brutit") ;
		fuska_V2_Cause_to_end = mkV2 (mkV "fuskar") ;
		arbeta_V2_Cause_to_end = mkV2 (mkV "arbetar") ;
		lyfta_V2_Cause_to_end = mkV2 (mkV "lyfta" "lyfter" "lyft" "lyfte" "lyft" "lyft") ;
		slå_V2_Cause_to_end = mkV2 (mkV "slå" "slog" "slagit") ;

		förlusta_V2_Cause_to_experience = mkV2 (mkV "förlustar") ;
		terrorisera_V2_Cause_to_experience = mkV2 (mkV "terroriserar") ;

		bryta_V2_Cause_to_fragment = mkV2 (mkV "bryta" "bröt" "brutit") ;
		paja_V2_Cause_to_fragment = mkV2 (mkV "pajar") ;
		slå_V2_Cause_to_fragment = mkV2 (mkV "slå" "slog" "slagit") ;

		spela_V2_Cause_to_make_noise = mkV2 (mkV "spelar") ;

		förbättra_V2_Cause_to_make_progress = mkV2 (mkV "förbättrar") ;
		förnya_V2_Cause_to_make_progress = mkV2 (mkV "förnyar") ;
		...
		starta_V2_Cause_to_resume = mkV2 (mkV "startar") ;
		återuppliva_V2_Cause_to_resume = mkV2 (mkV "återupplivar") ;

		driva_V2_Cause_to_start = mkV2 (mkV "driva" "drev" "drivit") ;
		få_V2_Cause_to_start = mkV2 (mkV "få" "fick" "fått") ;
		tända_V2_Cause_to_start = mkV2 (mkV "tänder") ;
		provocera_V2_Cause_to_start = mkV2 (mkV "provocerar") ;
		...
		dö_V_Ceasing_to_be = mkV "dö" "dog" "dött" ;
		försvinna_V_Ceasing_to_be = mkV "försvinna" "försvann" "försvunnit" ;
		gå_V_Ceasing_to_be = mkV "gå" "går" "gå" "gick" "gått" "gången" ;

		tvivla_V_Certainty = mkV "tvivlar" ;
		tro_VS_Certainty = mkVS (mkV "tror") ;

		böja_V_Change_direction = mkV "böja" "böjde" "böjt" ;
		slå_V_Change_direction = mkV "slå" "slog" "slagit" ;
		svänga_V_Change_direction = mkV "svänger" ;
		ta_V_Change_direction = mkV "ta" "tar" "ta" "tog" "tagit" "tagen" ;
		vända_V_Change_direction = mkV "vänder" ;
		ändra_V_Change_direction = mkV "ändrar" ;

		förkorta_V2_Change_event_duration = mkV2 (mkV "förkortar") ;
		...
		vila_V_Change_event_time = mkV "vilar" ;
		skjuta_V2_Change_event_time = mkV2 (mkV "skjuta" "sköt" "skjutit") ;
		försena_V2_Change_event_time = mkV2 (mkV "försenar") ;

		gelea_V_Change_of_consistency = mkV "gelear" ;
		skära_V_Change_of_consistency = mkV "skära" "skar" "skurit" ;
		...
		smälta_V_Change_of_phase = mkV "smälta" "smalt" "smultit" ;
		tillfrysa_V_Change_of_phase = mkV "tillfryser" ;
		tina_V_Change_of_phase = mkV "tinar" ;

		knäppa_V2_Change_operational_state = mkV2 (mkV "knäpper") ;
		slå_V2_Change_operational_state = mkV2 (mkV "slå" "slog" "slagit") ;
		aktivera_V2_Change_operational_state = mkV2 (mkV "aktiverar") ;

		växla_V_Change_position_on_a_scale = mkV "växlar" ;

		luta_V_Change_posture = mkV "lutar" ;
		resa_V_Change_posture = mkV "reser" ;
		sträcka_V_Change_posture = mkV "sträcker" ;
		stå_V_Change_posture = mkV "stå" "stod" "stått" ;

		byta_V_Change_tool = mkV "byter" ;
		gå_V_Change_tool = mkV "gå" "går" "gå" "gick" "gått" "gången" ;

		slå_V_Chatting = mkV "slå" "slog" "slagit" ;
		småprata_V_Chatting = mkV "småpratar" ;
		prata_V_Chatting = mkV "pratar" ;
		samtala_V_Chatting = mkV "samtalar" ;
		snacka_V_Chatting = mkV "snackar" ;

		handplocka_V2_Choosing = mkV2 (mkV "handplockar") ;
		se_V2_Choosing = mkV2 (mkV "se" "såg" "sett") ;
		selektera_V2_Choosing = mkV2 (mkV "selekterar") ;
		toppa_V2_Choosing = mkV2 (mkV "toppar") ;
		välja_V2_Choosing = mkV2 (mkV "välja" "valde" "valt") ;
		plocka_V2_Choosing = mkV2 (mkV "plockar") ;

		göra_V2_Claim_ownership = mkV2 (mkV "göra" "gjorde" "gjort") ;
		muta_V2_Claim_ownership = mkV2 (mkV "mutar") ;

		skalka_V2_Closure = mkV2 (mkV "skalkar") ;
		tillsluta_V2_Closure = mkV2 (mkV "tillsluta" "tillslöt" "tillslutit") ;
		fästa_V2_Closure = mkV2 (mkV "fästa" "fäster" "fäst" "fäste" "fäst" "fäst") ;
		...
		stå_V_Collaboration = mkV "stå" "stod" "stått" ;
		arbeta_V_Collaboration = mkV "arbetar" ;

		stöta_V_Come_together = mkV "stöter" ;

		-- No target for Coming_to_be

		bestämma_V2_Coming_to_believe = mkV2 (mkV "bestämmer") ;
		finna_VS_Coming_to_believe = mkVS (mkV "finna" "fann" "funnit") ;
		tippa_VS_Coming_to_believe = mkVS (mkV "tippar") ;
		lära_VV_Coming_to_believe = mkVV (mkV "lära" "lärde" "lärt") ;

		designa_V2_Coming_up_with = mkV2 (mkV "designar") ;
		dikta_V2_Coming_up_with = mkV2 (mkV "diktar") ;
		kläcka_V2_Coming_up_with = mkV2 (mkV "kläcker") ;
		...
		köpa_V2_Commerce_buy = mkV2 (mkV "köper") ;

		kränga_V_Commerce_sell = mkV "kränger" ;
		saluföra_V2_Commerce_sell = mkV2 (mkV "saluföra" "saluförde" "salufört") ;
		sälja_V2_Commerce_sell = mkV2 (mkV "sälja" "sålde" "sålt") ;
		avyttra_V2_Commerce_sell = mkV2 (mkV "avyttrar") ;

		svära_V_Commitment = mkV "svära" "svor" "svurit" ;
		svära_VS_Commitment = mkVS (mkV "svära" "svor" "svurit") ;
		utfästa_VV_Commitment = mkVV (mkV "utfästa" "utfäster" "utfäst" "utfäste" "utfäst" "utfäst") ;
		...
		bryta_V_Communication_manner = mkV "bryta" "bröt" "brutit" ;
		pladdra_V_Communication_manner = mkV "pladdrar" ;
		sjunga_V_Communication_manner = mkV "sjunga" "sjöng" "sjungit" ;
		stamma_V_Communication_manner = mkV "stammar" ;
		artikulera_V2_Communication_manner = mkV2 (mkV "artikulerar") ;
		sjunga_V2_Communication_manner = mkV2 (mkV "sjunga" "sjöng" "sjungit") ;

		faxa_V_Communication_means = mkV "faxar" ;
		messa_V_Communication_means = mkV "messar" ;
		ringa_V_Communication_means = mkV "ringer" ;
		faxa_V2_Communication_means = mkV2 (mkV "faxar") ;

		skrika_VS_Communication_noise = mkVS (mkV "skrika" "skrek" "skrikit") ;

		svara_V_Communication_response = mkV "svarar" ;
		replikera_VS_Communication_response = mkVS (mkV "replikerar") ;
		svara_VS_Communication_response = mkVS (mkV "svarar") ;
		...
		ta_V2_Conquering = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;
		...
		komma_V_Contingency = mkV "komma" "kom" "kommit" ;

		känna_V_Contrition = mkV "känna" "kände" "känt" ;
		...
		göra_V2_Cooking_creation = mkV2 (mkV "göra" "gjorde" "gjort") ;
		laga_V2_Cooking_creation = mkV2 (mkV "lagar") ;
		...
		måla_V2_Create_physical_artwork = mkV2 (mkV "målar") ;
		...
		måla_V2_Create_representation = mkV2 (mkV "målar") ;
		porträttera_V2_Create_representation = mkV2 (mkV "porträtterar") ;

		frambringa_V2_Creating = mkV2 (mkV "frambringar") ;
		ge_V2_Creating = mkV2 (mkV "ge" "ger" "ge" "gav" "gett" "given") ;
		skapa_V2_Creating = mkV2 (mkV "skapar") ;
		sätta_V2_Creating = mkV2 (mkV "sätta" "sätter" "sätt" "satte" "satt" "satt") ;

		undersöka_V2_Criminal_investigation = mkV2 (mkV "undersöker") ;
		utreda_V2_Criminal_investigation = mkV2 (mkV "utreda" "utredde" "utrett") ;

		hugga_V2_Cutting = mkV2 (mkV "hugga" "högg" "huggit") ;
		klippa_V2_Cutting = mkV2 (mkV "klipper") ;
		sönderdela_V2_Cutting = mkV2 (mkV "sönderdelar") ;
		toppa_V2_Cutting = mkV2 (mkV "toppar") ;

		riva_V2_Damaging = mkV2 (mkV "riva" "rev" "rivit") ;
		skjuta_V2_Damaging = mkV2 (mkV "skjuta" "sköt" "skjutit") ;
		vandalisera_V2_Damaging = mkV2 (mkV "vandaliserar") ;

		våga_V2_Daring = mkV2 (mkV "vågar") ;
		ta_VV_Daring = mkVV (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;
		våga_VV_Daring = mkVV (mkV "vågar") ;

		avsomna_V_Death = mkV "avsomnar" ;
		bära_V_Death = mkV "bära" "bar" "burit" ;
		dö_V_Death = mkV "dö" "dog" "dött" ;
		gå_V_Death = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		stryka_V_Death = mkV "stryka" "strök" "strukit" ;
		...
		förbjuda_V2V_Deny_permission = mkV2V (mkV "förbjuda" "förbjöd" "förbjudit") ;

		lämna_V2_Departing = mkV2 (mkV "lämnar") ;

		förtjäna_V2_Deserving = mkV2 (mkV "förtjänar") ;

		längta_V_Desiring = mkV "längtar" ;
		känna_V2_Desiring = mkV2 (mkV "känna" "kände" "känt") ;
		känna_VV_Desiring = mkVV (mkV "känna" "kände" "känt") ;

		förinta_V2_Destroying = mkV2 (mkV "förintar") ;
		demolera_V2_Destroying = mkV2 (mkV "demolerar") ;
		spränga_V2_Destroying = mkV2 (mkV "spränger") ;
		tillintetgöra_V2_Destroying = mkV2 (mkV "tillintetgöra" "tillintetgjorde" "tillintetgjort") ;
		ödelägga_V2_Destroying = mkV2 (mkV "ödelägga" "ödelade" "ödelagt") ;
		jämna_V2_Destroying = mkV2 (mkV "jämnar") ;
		...
		sprida_V2_Dispersal = mkV2 (mkV "sprida" "spred" "spritt") ;
		...
		klä_V_Dressing = mkV "kläda" "klär" "klä" "klädde" "klätt" "klädd" ;
		kostymera_V_Dressing = mkV "kostymerar" ;
		skruda_V_Dressing = mkV "skrudar" ;
		sätta_V2_Dressing = mkV2 (mkV "sätta" "sätter" "sätt" "satte" "satt" "satt") ;
		ta_V2_Dressing = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;

		smita_V_Drop_in_on = mkV "smita" "smet" "smitit" ;

		dippa_V2_Dunking = mkV2 (mkV "dippar") ;

		tjäna_V_Earnings_and_losses = mkV "tjänar" ;
		förlora_V2_Earnings_and_losses = mkV2 (mkV "förlorar") ;
		göra_V2_Earnings_and_losses = mkV2 (mkV "göra" "gjorde" "gjort") ;
		tjäna_V2_Earnings_and_losses = mkV2 (mkV "tjänar") ;

		avskärma_V_Eclipse = mkV "avskärmar" ;
		gömma_V_Eclipse = mkV "gömmer" ;
		blockera_V2_Eclipse = mkV2 (mkV "blockerar") ;
		skymma_V2_Eclipse = mkV2 (mkV "skymmer") ;
		förmörka_V2_Eclipse = mkV2 (mkV "förmörkar") ;

		studera_V_Education_teaching = mkV "studerar" ;
		lära_V2_Education_teaching = mkV2 (mkV "lära" "lärde" "lärt") ;

		gäcka_V2_Elusive_goal = mkV2 (mkV "gäckar") ;

		komma_V_Emanating = mkV "komma" "kom" "kommit" ;
		lysa_V_Emanating = mkV "lyser" ;
		ryka_V_Emanating = mkV "ryker" ;
		stråla_V_Emanating = mkV "strålar" ;

		ge_V2_Emitting = mkV2 (mkV "ge" "ger" "ge" "gav" "gett" "given") ;
		utstråla_V2_Emitting = mkV2 (mkV "utstrålar") ;
		utsöndra_V2_Emitting = mkV2 (mkV "utsöndrar") ;

		bekymra_V_Emotion_active = mkV "bekymrar" ;
		oroa_V_Emotion_active = mkV "oroar" ;

		brinna_V_Emotion_heat = mkV "brinna" "brann" "brunnit" ;
		koka_V_Emotion_heat = mkV "kokar" ;
		sjuda_V_Emotion_heat = mkV "sjuda" "sjöd" "sjudit" ;

		anställa_V2_Employing = mkV2 (mkV "anställer") ;

		avfrosta_V_Emptying = mkV "avfrostar" ;
		avlusa_V2_Emptying = mkV2 (mkV "avlusar") ;
		duka_V2_Emptying = mkV2 (mkV "dukar") ;
		tömma_V2_Emptying = mkV2 (mkV "tömmer") ;
		ösa_V2_Emptying = mkV2 (mkV "öser") ;
		avfrosta_V2_Emptying = mkV2 (mkV "avfrostar") ;
		göra_V2_Emptying = mkV2 (mkV "göra" "gjorde" "gjort") ;
		kalhugga_V2_Emptying = mkV2 (mkV "kalhugga" "kalhögg" "kalhuggit") ;

		formulera_V_Encoding = mkV "formulerar" ;
		...
		utsätta_V2_Endangering = mkV2 (mkV "utsätta" "utsätter" "utsätt" "utsatte" "utsatt" "utsatt") ;

		genomdriva_V2_Enforcing = mkV2 (mkV "genomdriva" "genomdrev" "genomdrivit") ;
		genomföra_V2_Enforcing = mkV2 (mkV "genomföra" "genomförde" "genomfört") ;
		tvinga_V2_Enforcing = mkV2 (mkV "tvingar") ;

		förklara_V_Entering_of_plea = mkV "förklarar" ;
		...
		gäcka_V2_Evading = mkV2 (mkV "gäckar") ;
		hålla_V2_Evading = mkV2 (mkV "hålla" "höll" "hållit") ;
		komma_V2_Evading = mkV2 (mkV "komma" "kom" "kommit") ;
		...
		spy_V2_Excreting = mkV2 (mkV "spyr") ;
		...
		bryta_V2_Experience_bodily_harm = mkV2 (mkV "bryta" "bröt" "brutit") ;
		skada_V2_Experience_bodily_harm = mkV2 (mkV "skadar") ;

		avguda_V2_Experiencer_focus = mkV2 (mkV "avgudar") ;
		älska_V2_Experiencer_focus = mkV2 (mkV "älskar") ;

		förblinda_V_Experiencer_obj = mkV "förblindar" ;
		lena_V_Experiencer_obj = mkV "lenar" ;
		slå_V_Experiencer_obj = mkV "slå" "slog" "slagit" ;
		...
		slå_V2_Experiencer_obj = mkV2 (mkV "slå" "slog" "slagit") ;
		...
		klä_V2_Expressing_publicly = mkV2 (mkV "kläda" "klär" "klä" "klädde" "klätt" "klädd") ;
		lufta_V2_Expressing_publicly = mkV2 (mkV "luftar") ;
		ventilera_V2_Expressing_publicly = mkV2 (mkV "ventilerar") ;

		utlämna_V2_Extradition = mkV2 (mkV "utlämnar") ;

		känna_V2_Familiarity = mkV2 (mkV "känna" "kände" "känt") ;

		känna_V_Feeling = mkV "känna" "kände" "känt" ;
		uppleva_V2_Feeling = mkV2 (mkV "upplever") ;

		simulera_V2_Feigning = mkV2 (mkV "simulerar") ;

		fylla_V2_Filling = mkV2 (mkV "fyller") ;
		klä_V2_Filling = mkV2 (mkV "kläda" "klär" "klä" "klädde" "klätt" "klädd") ;
		slå_V2_Filling = mkV2 (mkV "slå" "slog" "slagit") ;
		proppa_V2_Filling = mkV2 (mkV "proppar") ;
		stryka_V2_Filling = mkV2 (mkV "stryka" "strök" "strukit") ;

		leda_V2_Finish_competition = mkV2 (mkV "leda" "ledde" "lett") ;
		vinna_V2_Finish_competition = mkV2 (mkV "vinna" "vann" "vunnit") ;

		förlora_V_Finish_game = mkV "förlorar" ;
		vinna_V_Finish_game = mkV "vinna" "vann" "vunnit" ;

		friställa_V2_Firing = mkV2 (mkV "friställer") ;
		säga_V2_Firing = mkV2 (mkV "säga" "sade" "sagt") ;

		skena_V_Fleeing = mkV "skenar" ;
		smita_V_Fleeing = mkV "smita" "smet" "smitit" ;
		fly_V_Fleeing = mkV "flyr" ;

		sippra_V_Fluidic_motion = mkV "sipprar" ;
		cirkulera_V_Fluidic_motion = mkV "cirkulerar" ;
		flyta_V_Fluidic_motion = mkV "flyta" "flöt" "flutit" ;
		rinna_V_Fluidic_motion = mkV "rinna" "rann" "runnit" ;
		strömma_V_Fluidic_motion = mkV "strömmar" ;

		-- No target for Forging

		avstå_V_Forgoing = mkV "avstå" "avstod" "avstått" ;
		låta_VV_Forgoing = mkVV (mkV "låta" "lät" "låtit") ;

		bryta_V_Forming_relationships = mkV "bryta" "bröt" "brutit" ;
		göra_V_Forming_relationships = mkV "göra" "gjorde" "gjort" ;
		äkta_V2_Forming_relationships = mkV2 (mkV "äktar") ;

		knirka_V_Friction = mkV "knirkar" ;
		skrapa_V_Friction = mkV "skrapar" ;

		dra_V2_Gathering_up = mkV2 (mkV "dra" "drar" "dra" "drog" "dragit" "dragen") ;
		sammankalla_V2_Gathering_up = mkV2 (mkV "sammankallar") ;
		båda_V2_Gathering_up = mkV2 (mkV "bådar") ;
		föra_V2_Gathering_up = mkV2 (mkV "föra" "förde" "fört") ;
		kalla_V2_Gathering_up = mkV2 (mkV "kallar") ;
		...
		skaffa_V2_Getting = mkV2 (mkV "skaffar") ;
		säkra_V2_Getting = mkV2 (mkV "säkrar") ;

		köra_V2_Getting_vehicle_underway = mkV2 (mkV "köra" "körde" "kört") ;

		donera_V2_Giving = mkV2 (mkV "donerar") ;
		ge_V2_Giving = mkV2 (mkV "ge" "ger" "ge" "gav" "gett" "given") ;
		ägna_V2_Giving = mkV2 (mkV "ägnar") ;

		fälla_V_Go_into_shape = mkV "fäller" ;
		krusa_V_Go_into_shape = mkV "krusar" ;
		kröka_V_Go_into_shape = mkV "kröker" ;
		locka_V_Go_into_shape = mkV "lockar" ;
		rulla_V_Go_into_shape = mkV "rullar" ;
		räta_V_Go_into_shape = mkV "rätar" ;
		vika_V_Go_into_shape = mkV "vika" "vek" "vikit" ;
		...
		smula_V2_Grinding = mkV2 (mkV "smular") ;

		rengöra_V_Grooming = mkV "rengöra" "rengjorde" "rengjort" ;
		skrubba_V_Grooming = mkV "skrubbar" ;
		borsta_V2_Grooming = mkV2 (mkV "borstar") ;
		sprita_V2_Grooming = mkV2 (mkV "spritar") ;
		tvätta_V2_Grooming = mkV2 (mkV "tvättar") ;
		två_V2_Grooming = mkV2 (mkV "tvår") ;

		göra_V_Halt = mkV "göra" "gjorde" "gjort" ;
		stanna_V_Halt = mkV "stannar" ;

		höra_V_Hear = mkV "höra" "hörde" "hört" ;
		höra_V2_Hear = mkV2 (mkV "höra" "hörde" "hört") ;
		höra_VS_Hear = mkVS (mkV "höra" "hörde" "hört") ;

		dölja_V2_Hiding_objects = mkV2 (mkV "dölja" "dolde" "dolt") ;
		gömma_V2_Hiding_objects = mkV2 (mkV "gömmer") ;
		...
		fiska_V_Hunting = mkV "fiskar" ;
		jaga_V_Hunting = mkV "jagar" ;
		...
		plöja_V_Impact = mkV "plöja" "plöjde" "plöjt" ;
		slå_V_Impact = mkV "slå" "slog" "slagit" ;
		...
		peka_V2_Indicating = mkV2 (mkV "pekar") ;
		...
		hugga_V_Ingestion = mkV "hugga" "högg" "huggit" ;
		äta_V_Ingestion = mkV "äta" "åt" "ätit" ;
		dricka_V_Ingestion = mkV "dricka" "drack" "druckit" ;
		dricka_V2_Ingestion = mkV2 (mkV "dricka" "drack" "druckit") ;
		äta_V2_Ingestion = mkV2 (mkV "äta" "åt" "ätit") ;
		inta_V2_Ingestion = mkV2 (mkV "inta" "intar" "inta" "intog" "intagit" "intagen") ;

		fjättra_V_Inhibit_movement = mkV "fjättrar" ;
		hålla_V2_Inhibit_movement = mkV2 (mkV "hålla" "höll" "hållit") ;
		...
		bestiga_V2_Intentional_traversing = mkV2 (mkV "bestiga" "besteg" "bestigit") ;

		bilda_V2_Intentionally_create = mkV2 (mkV "bildar") ;
		göra_V2_Intentionally_create = mkV2 (mkV "göra" "gjorde" "gjort") ;
		...
		slå_V2_Killing = mkV2 (mkV "slå" "slog" "slagit") ;

		knyta_V2_Knot_creation = mkV2 (mkV "knyta" "knöt" "knutit") ;
		...
		lysa_V_Location_of_light = mkV "lyser" ;
		skimra_V_Location_of_light = mkV "skimrar" ;

		bli_V2_Losing = mkV2 (mkV "bli" "blev" "blivit") ;
		tappa_V2_Losing = mkV2 (mkV "tappar") ;

		mala_V_Make_noise = mkV "maler" ;
		säga_V2_Make_noise = mkV2 (mkV "säga" "sade" "sagt") ;

		möjliggöra_V2_Make_possible_to_do = mkV2 (mkV "möjliggöra" "möjliggjorde" "möjliggjort") ;
		tillåta_V2_Make_possible_to_do = mkV2 (mkV "tillåta" "tillät" "tillåtit") ;
		...
		gripa_V2_Manipulation = mkV2 (mkV "gripa" "grep" "gripit") ;
		hålla_V2_Manipulation = mkV2 (mkV "hålla" "höll" "hållit") ;
		topsa_V2_Manipulation = mkV2 (mkV "topsar") ;

		göra_V2_Manufacturing = mkV2 (mkV "göra" "gjorde" "gjort") ;
		ta_V2_Manufacturing = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;
		tillverka_V2_Manufacturing = mkV2 (mkV "tillverkar") ;

		bre_V_Mass_motion = mkV "breda" "bredde" "brett" ;
		sprida_V_Mass_motion = mkV "sprida" "spred" "spritt" ;
		välla_V_Mass_motion = mkV "väller" ;
		tränga_V_Mass_motion = mkV "tränger" ;
		...
		hålla_V2_Meet_specifications = mkV2 (mkV "hålla" "höll" "hållit") ;
		...
		motta_V2_Meet_with_response = mkV2 (mkV "motta" "mottar" "motta" "mottog" "mottagit" "mottagen") ;
		...
		komma_V2_Memory = mkV2 (mkV "komma" "kom" "kommit") ;
		glömma_VS_Memory = mkVS (mkV "glömmer") ;
		...
		tycka_VS_Opinion = mkVS (mkV "tycker") ;

		komma_V_Origin = mkV "komma" "kom" "kommit" ;

		sympatisera_V_Others_situation_as_stimulus = mkV "sympatiserar" ;
		tycka_V_Others_situation_as_stimulus = mkV "tycker" ;
		känna_V2_Others_situation_as_stimulus = mkV2 (mkV "känna" "kände" "känt") ;

		benåda_V2_Pardon = mkV2 (mkV "benådar") ;

		gynna_V2_Partiality = mkV2 (mkV "gynnar") ;

		röra_V_Participation = mkV "röra" "rörde" "rört" ;

		stiga_V_Path_shape = mkV "stiga" "steg" "stigit" ;
		svänga_V_Path_shape = mkV "svänger" ;
		gå_V_Path_shape = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		löpa_V_Path_shape = mkV "löper" ;
		korsa_V2_Path_shape = mkV2 (mkV "korsar") ;

		hugga_V_Perception_body = mkV "hugga" "högg" "huggit" ;
		kittla_V_Perception_body = mkV "kittlar" ;
		sticka_V_Perception_body = mkV "sticka" "stack" "stuckit" ;
		...
		tillåta_V2_Permitting = mkV2 (mkV "tillåta" "tillät" "tillåtit") ;
		...
		ge_V_Place_weight_on = mkV "ge" "ger" "ge" "gav" "gett" "given" ;
		lägga_V_Place_weight_on = mkV "lägga" "lade" "lagt" ;

		dra_V2_Placing = mkV2 (mkV "dra" "drar" "dra" "drog" "dragit" "dragen") ;
		placera_V2_Placing = mkV2 (mkV "placerar") ;
		slå_V2_Placing = mkV2 (mkV "slå" "slog" "slagit") ;
		stoppa_V2_Placing = mkV2 (mkV "stoppar") ;
		tvinga_V2_Placing = mkV2 (mkV "tvingar") ;
		...
		ligga_V_Posture = mkV "ligga" "låg" "legat" ;
		luta_V_Posture = mkV "lutar" ;
		sitta_V_Posture = mkV "sitta" "satt" "suttit" ;
		sätta_V_Posture = mkV "sätta" "sätter" "sätt" "satte" "satt" "satt" ;

		repa_V_Practice = mkV "repar" ;
		repetera_V_Practice = mkV "repeterar" ;
		öva_V_Practice = mkV "övar" ;
		repa_V2_Practice = mkV2 (mkV "repar") ;
		träna_V2_Practice = mkV2 (mkV "tränar") ;
		öva_V2_Practice = mkV2 (mkV "övar") ;
		...
		lägga_V2_Preserving = mkV2 (mkV "lägga" "lade" "lagt") ;
		sylta_V2_Preserving = mkV2 (mkV "syltar") ;

		ljuga_V_Prevarication = mkV "ljuga" "ljög" "ljugit" ;

		frånta_V3_Prevent_from_having = mkV3 (mkV "frånta" "fråntar" "frånta" "fråntog" "fråntagit" "fråntagen") ;

		avvärja_V2_Preventing = mkV2 (mkV "avvärja" "avvärjde" "avvärjt") ;
		förhindra_V2_Preventing = mkV2 (mkV "förhindrar") ;
		...
		gå_V_Process_continue = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		hålla_V_Process_continue = mkV "hålla" "höll" "hållit" ;
		pågå_V_Process_continue = mkV "pågå" "pågick" "pågått" ;

		sluta_V_Process_end = mkV "sluta" "slöt" "slutit" ;
		ta_V_Process_end = mkV "ta" "tar" "ta" "tog" "tagit" "tagen" ;
		upphöra_V_Process_end = mkV "upphöra" "upphörde" "upphört" ;
		utmynna_V_Process_end = mkV "utmynnar" ;

		bryta_V_Process_start = mkV "bryta" "bröt" "brutit" ;
		börja_V_Process_start = mkV "börjar" ;
		starta_V_Process_start = mkV "startar" ;
		sätta_V_Process_start = mkV "sätta" "sätter" "sätt" "satte" "satt" "satt" ;

		avstanna_V_Process_stop = mkV "avstannar" ;
		stanna_V_Process_stop = mkV "stannar" ;

		arbeta_V2_Processing_materials = mkV2 (mkV "arbetar") ;
		bearbeta_V2_Processing_materials = mkV2 (mkV "bearbetar") ;

		gå_V_Proliferating_in_number = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		...
		säga_V_Quitting = mkV "säga" "sade" "sagt" ;

		dra_V_Quitting_a_place = mkV "dra" "drar" "dra" "drog" "dragit" "dragen" ;
		dunsta_V_Quitting_a_place = mkV "dunstar" ;
		fly_V_Quitting_a_place = mkV "flyr" ;
		...
		komma_V_Recovery = mkV "komma" "kom" "kommit" ;
		återhämta_V_Recovery = mkV "återhämtar" ;
		läka_V_Recovery = mkV "läker" ;

		avleda_V2_Redirecting = mkV2 (mkV "avleda" "avledde" "avlett") ;
		avvända_V2_Redirecting = mkV2 (mkV "avvänder") ;
		dirigera_V2_Redirecting = mkV2 (mkV "dirigerar") ;
		styra_V2_Redirecting = mkV2 (mkV "styra" "styrde" "styrt") ;

		se_V2_Reference_text = mkV2 (mkV "se" "såg" "sett") ;
		...
		återuppliva_V2_Rejuvenation = mkV2 (mkV "återupplivar") ;
		vitalisera_V2_Rejuvenation = mkV2 (mkV "vitaliserar") ;

		binda_V2_Relating_concepts = mkV2 (mkV "binda" "band" "bundit") ;
		förbinda_V2_Relating_concepts = mkV2 (mkV "förbinda" "förband" "förbundit") ;
		förena_V2_Relating_concepts = mkV2 (mkV "förenar") ;
		relatera_V2_Relating_concepts = mkV2 (mkV "relaterar") ;
		sätta_V2_Relating_concepts = mkV2 (mkV "sätta" "sätter" "sätt" "satte" "satt" "satt") ;

		dra_V_Relative_time = mkV "dra" "drar" "dra" "drog" "dragit" "dragen" ;
		följa_V_Relative_time = mkV "följa" "följde" "följt" ;

		tro_V_Religious_belief = mkV "tror" ;
		tro_VS_Religious_belief = mkVS (mkV "tror") ;

		bli_V_Remainder = mkV "bli" "blev" "blivit" ;
		...
		glömma_VV_Remembering_to_do = mkVV (mkV "glömmer") ;
		komma_VV_Remembering_to_do = mkVV (mkV "komma" "kom" "kommit") ;

		göra_V_Removing = mkV "göra" "gjorde" "gjort" ;
		tömma_V2_Removing = mkV2 (mkV "tömmer") ;
		plocka_V2_Removing = mkV2 (mkV "plockar") ;
		slå_V2_Removing = mkV2 (mkV "slå" "slog" "slagit") ;
		vräka_V2_Removing = mkV2 (mkV "vräker") ;
		kränga_V3_Removing = mkV3 (mkV "kränger") ;
		abortera_V2_Removing = mkV2 (mkV "aborterar") ;
		...
		ta_V2_Render_nonfunctional = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;

		hyra_V2_Renting = mkV2 (mkV "hyra" "hyrde" "hyrt") ;

		arrendera_V2_Renting_out = mkV2 (mkV "arrenderar") ;
		hyra_V2_Renting_out = mkV2 (mkV "hyra" "hyrde" "hyrt") ;

		avsäga_V2_Renunciation = mkV2 (mkV "avsäga" "avsade" "avsagt") ;
		ge_V2_Renunciation = mkV2 (mkV "ge" "ger" "ge" "gav" "gett" "given") ;

		stå_V2_Repel = mkV2 (mkV "stå" "stod" "stått") ;

		byta_V2_Replacing = mkV2 (mkV "byter") ;
		...
		stå_V_Representing = mkV "stå" "stod" "stått" ;
		...
		kalla_V2_Request = mkV2 (mkV "kallar") ;
		...
		komma_V_Rising_to_a_challenge = mkV "komma" "kom" "kommit" ;
		svara_V_Rising_to_a_challenge = mkV "svarar" ;
		växa_V_Rising_to_a_challenge = mkV "växa" "växer" "växa" "växte" "vuxit" "vuxen" ;

		smörja_V2_Rite = mkV2 (mkV "smörja" "smorde" "smort") ;
		döpa_V2_Rite = mkV2 (mkV "döper") ;

		råna_V2_Robbery = mkV2 (mkV "rånar") ;

		vara_V_Rotting = mkV "varar" ;
		...
		spalta_V2_Separating = mkV2 (mkV "spaltar") ;

		blossa_V_Setting_fire = mkV "blossar" ;
		anlägga_V2_Setting_fire = mkV2 (mkV "anlägga" "anlade" "anlagt") ;
		lunta_V2_Setting_fire = mkV2 (mkV "luntar") ;

		bryta_V_Setting_out = mkV "bryta" "bröt" "brutit" ;
		sätta_V_Setting_out = mkV "sätta" "sätter" "sätt" "satte" "satt" "satt" ;

		avfyra_V2_Shoot_projectiles = mkV2 (mkV "avfyrar") ;
		bränna_V2_Shoot_projectiles = mkV2 (mkV "bränna" "brände" "bränt") ;
		skjuta_V2_Shoot_projectiles = mkV2 (mkV "skjuta" "sköt" "skjutit") ;

		gå_V_Sidereal_appearance = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		sjunka_V_Sidereal_appearance = mkV "sjunka" "sjönk" "sjunkit" ;
		stiga_V_Sidereal_appearance = mkV "stiga" "steg" "stigit" ;

		skriva_V2_Sign_agreement = mkV2 (mkV "skriva" "skrev" "skrivit") ;

		hyssja_V2_Silencing = mkV2 (mkV "hyssjar") ;
		tysta_V2_Silencing = mkV2 (mkV "tystar") ;

		stå_V_Similarity = mkV "stå" "stod" "stått" ;

		slagga_V_Sleep = mkV "slaggar" ;
		slumra_V_Sleep = mkV "slumrar" ;
		sova_V_Sleep = mkV "sova" "sov" "sovit" ;
		...
		bli_V_State_continue = mkV "bli" "blev" "blivit" ;
		förbli_V_State_continue = mkV "förbli" "förblev" "förblivit" ;
		gå_V_State_continue = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		hålla_V_State_continue = mkV "hålla" "höll" "hållit" ;
		stå_V_State_continue = mkV "stå" "stod" "stått" ;

		rapportera_V_Statement = mkV "rapporterar" ;
		skriva_V_Statement = mkV "skriva" "skrev" "skrivit" ;
		tala_V_Statement = mkV "talar" ;
		...
		ligga_V_Studying = mkV "ligga" "låg" "legat" ;
		studera_V2_Studying = mkV2 (mkV "studerar") ;

		förmå_V2V_Suasion = mkV2V (mkV "förmår") ;
		övertala_V2V_Suasion = mkV2V (mkV "övertalar") ;
		övertala_V2_Suasion = mkV2 (mkV "övertalar") ;

		lämna_V2_Submitting_documents = mkV2 (mkV "lämnar") ;
		skicka_V2_Submitting_documents = mkV2 (mkV "skickar") ;
		sända_V2_Submitting_documents = mkV2 (mkV "sänder") ;

		bita_V_Success_or_failure = mkV "bita" "bet" "bitit" ;
		göra_V_Success_or_failure = mkV "göra" "gjorde" "gjort" ;
		ta_V_Success_or_failure = mkV "ta" "tar" "ta" "tog" "tagit" "tagen" ;
		klara_VV_Success_or_failure = mkVV (mkV "klarar") ;

		göra_V_Successful_action = mkV "göra" "gjorde" "gjort" ;
		gå_V_Successful_action = mkV "gå" "går" "gå" "gick" "gått" "gången" ;
		slå_V_Successful_action = mkV "slå" "slog" "slagit" ;
		...
		stödja_V2_Supporting = mkV2 (mkV "stöda" "stödde" "stött") ;
		stötta_V2_Supporting = mkV2 (mkV "stöttar") ;

		överlämna_V_Surrendering = mkV "överlämnar" ;

		lämna_V2_Surrendering_possession = mkV2 (mkV "lämnar") ;
		...
		berätta_V_Telling = mkV "berättar" ;
		komma_V_Telling = mkV "komma" "kom" "kommit" ;
		dra_V2_Telling = mkV2 (mkV "dra" "drar" "dra" "drog" "dragit" "dragen") ;
		berätta_VS_Telling = mkVS (mkV "berättar") ;

		sova_V_Temporary_stay = mkV "sova" "sov" "sovit" ;
		bo_V_Temporary_stay = mkV "bor" ;

		komma_V_Text_creation = mkV "komma" "kom" "kommit" ;
		skriva_V2_Text_creation = mkV2 (mkV "skriva" "skrev" "skrivit") ;
		säga_V2_Text_creation = mkV2 (mkV "säga" "sade" "sagt") ;

		snatta_V_Theft = mkV "snattar" ;
		förskingra_V2_Theft = mkV2 (mkV "förskingrar") ;
		...
		säga_VS_Unattributed_information = mkVS (mkV "säga" "sade" "sagt") ;

		slå_V_Undergo_change = mkV "slå" "slog" "slagit" ;
		...
		underkasta_V2_Undergoing = mkV2 (mkV "underkastar") ;

		avklä_V2_Undressing = mkV2 (mkV "avklär") ;
		dra_V2_Undressing = mkV2 (mkV "dra" "drar" "dra" "drog" "dragit" "dragen") ;
		sparka_V2_Undressing = mkV2 (mkV "sparkar") ;
		ta_V2_Undressing = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;

		avfyra_V2_Use_firearm = mkV2 (mkV "avfyrar") ;

		begagna_V2_Using = mkV2 (mkV "begagnar") ;
		ta_V2_Using = mkV2 (mkV "ta" "tar" "ta" "tog" "tagit" "tagen") ;
		tillämpa_V2_Using = mkV2 (mkV "tillämpar") ;

		finna_V2_Verdict = mkV2 (mkV "finna" "fann" "funnit") ;

		slå_VS_Wagering = mkVS (mkV "slå" "slog" "slagit") ;

		vänta_V_Waiting = mkV "väntar" ;
		...
		bära_V2_Wearing = mkV2 (mkV "bära" "bar" "burit") ;
