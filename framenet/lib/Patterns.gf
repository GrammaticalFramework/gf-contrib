abstract Patterns = Elements ** {
	...
	fun
		...
		Behind_the_scenes_V2 : Artist_NP -> Production_NP -> V2 -> Clause ;
		...
		Bringing_V2_1 : Agent_NP -> Theme_NP -> V2 -> Clause ;
		...
		Cause_change_V2_1 : Agent_NP -> Entity_NP -> Final_category_Adv -> V2 -> Clause ;
		Cause_change_V2_2 : Cause_NP -> Entity_NP -> V2 -> Clause ;
		...
		Cause_to_be_included_V2 : Agent_NP -> New_member_NP -> V2 -> Clause ;
		...
		Change_event_time_V : Agent_NP -> Event_Adv -> V -> Clause ;
		...
		Come_together_V : Party_1_NP -> Party_2_Adv -> V -> Clause ;
		...
		Communication_V2 : Communicator_NP -> Message_NP -> V2 -> Clause ;
		Communication_VS : Communicator_NP -> Message_S -> VS -> Clause ;

		Communication_manner_V : Speaker_NP -> Topic_Adv -> V -> Clause ;
		Communication_manner_V2 : Message_NP -> Speaker_NP -> V2 -> Clause ;

		Communication_means_V : Addressee_Adv -> Communicator_NP -> V -> Clause ;
		Communication_means_V2 : Addressee_Adv -> Message_NP -> V2 -> Clause ;
		...
		Contacting_V2 : Addressee_NP -> Communicator_NP -> V2 -> Clause ;
		...
		Damaging_V2 : Agent_NP -> Patient_NP -> V2 -> Clause ;
		...
		Dunking_V2 : Substance_Adv -> Theme_NP -> V2 -> Clause ;
		...
		Education_teaching_V2 : Role_Adv -> Student_NP -> Teacher_NP -> V2 -> Clause ;
		...
		Emptying_V : Source_NP -> V -> Clause ;
		Emptying_V2 : Agent_NP -> Source_NP -> Theme_Adv -> V2 -> Clause ;
		...
		Indicating_V2 : Communicator_NP -> Unresolved_referent_NP -> V2 -> Clause ;
		...
		Manufacturing_V2 : Product_NP -> V2 -> Clause ;
		...
		Motion_noise_V : Area_Adv -> Theme_NP -> V -> Clause ;
		...
		Rejuvenation_V2 : Agent_NP -> Entity_NP -> V2 -> Clause ;
		...
		Removing_V2_1 : Agent_NP -> Source_NP -> V2 -> Clause ;
		Removing_V2_2 : Agent_NP -> Theme_NP -> V2 -> Clause ;
		Removing_V2_3 : Source_Adv -> Theme_NP -> V2 -> Clause ;
		Removing_V3 : Source_NP -> Theme_NP -> V3 -> Clause ;
		...
		Request_V : Message_Adv -> Speaker_NP -> V -> Clause ;
		Request_V2 : Message_NP -> Speaker_NP -> V2 -> Clause ;
		...
		Ruling_legally_VS : Authority_NP -> Finding_S -> VS -> Clause ;
		...
		Success_or_failure_V2_Pass : Agent_NP -> Goal_Adv -> V2 -> Clause ;
		...
		Supply_V2 : Recipient_NP -> Supplier_NP -> V2 -> Clause ;
		...
		Telling_V2 : Message_NP -> Speaker_NP -> V2 -> Clause ;
		Telling_VS : Message_S -> Speaker_NP -> VS -> Clause ;

		Temporary_stay_V_1 : Guest_NP -> Host_Adv -> V -> Clause ;
		Temporary_stay_V_2 : Guest_NP -> Location_Adv -> V -> Clause ;

		Text_creation_V : Author_Adv -> V -> Clause ;
		...
		Topic_V2 : Text_NP -> Topic_NP -> V2 -> Clause ;

		Travel_V : Traveler_NP -> V -> Clause ;
