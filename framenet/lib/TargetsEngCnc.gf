concrete TargetsEngCnc of TargetsEngAbs = CatEng ** open ParadigmsEng, IrregEng, StructuralEng in {
	...
	lin
		...
		abound_V_Abundance = mkV "abound" "abounds" "abounded" "abounded" "abounding" ;
		...
		stop_V2_Activity_stop = mkV2 (regDuplV "stop") ;
		terminate_V2_Activity_stop = mkV2 (mkV "terminate" "terminates" "terminated" "terminated" "terminating") ;
		cease_VV_Activity_stop = mkVV (mkV "cease" "ceases" "ceased" "ceased" "ceasing") ;
		discontinue_VV_Activity_stop = mkVV (mkV "discontinue" "discontinues" "discontinued" "discontinued" "discontinuing") ;
		stop_VV_Activity_stop = mkVV (regDuplV "stop") ;
		...
		adorn_V2_Adorning = mkV2 (mkV "adorn" "adorns" "adorned" "adorned" "adorning") ;
		blanket_V2_Adorning = mkV2 (mkV "blanket" "blankets" "blanketed" "blanketed" "blanketing") ;
		cloak_V2_Adorning = mkV2 (mkV "cloak" "cloaks" "cloaked" "cloaked" "cloaking") ;
		coat_V2_Adorning = mkV2 (mkV "coat" "coats" "coated" "coated" "coating") ;
		cover_V2_Adorning = mkV2 (mkV "cover" "covers" "covered" "covered" "covering") ;
		deck_V2_Adorning = mkV2 (mkV "deck" "decks" "decked" "decked" "decking") ;
		decorate_V2_Adorning = mkV2 (mkV "decorate" "decorates" "decorated" "decorated" "decorating") ;
		dot_V2_Adorning = mkV2 (mkV "dot" "dots" "dotted" "dotted" "dotting") ;
		encircle_V2_Adorning = mkV2 (mkV "encircle" "encircles" "encircled" "encircled" "encircling") ;
		envelop_V2_Adorning = mkV2 (mkV "envelop" "envelops" "enveloped" "enveloped" "enveloping") ;
		festoon_V2_Adorning = mkV2 (mkV "festoon" "festoons" "festooned" "festooned" "festooning") ;
		fill_V2_Adorning = mkV2 (mkV "fill" "fills" "filled" "filled" "filling") ;
		film_V2_Adorning = mkV2 (mkV "film" "films" "filmed" "filmed" "filming") ;
		line_V2_Adorning = mkV2 (mkV "line" "lines" "lined" "lined" "lining") ;
		pave_V2_Adorning = mkV2 (mkV "pave" "paves" "paved" "paved" "paving") ;
		stud_V2_Adorning = mkV2 (mkV "stud" "studs" "studded" "studded" "studding") ;
		wreathe_V2_Adorning = mkV2 (mkV "wreathe" "wreathes" "wreathed" "wreathed" "wreathing") ;
		...
		microwave_V2_Apply_heat = variants {} ;
		...
		apprehend_V2_Arrest = mkV2 (mkV "apprehend" "apprehends" "apprehended" "apprehended" "apprehending") ;
		arrest_V2_Arrest = mkV2 (mkV "arrest" "arrests" "arrested" "arrested" "arresting") ;
		bust_V2_Arrest = mkV2 (mkV "bust" "busts" "busted" "busted" "busting") ;
		collar_V2_Arrest = mkV2 (mkV "collar" "collars" "collared" "collared" "collaring") ;
		cop_V2_Arrest = mkV2 (mkV "cop" "cops" "copped" "copped" "copping") ;
		nab_V2_Arrest = mkV2 (mkV "nab" "nabs" "nabbed" "nabbed" "nabbing") ;
		summons_V2_Arrest = mkV2 (mkV "summons" "summonses" "summonsed" "summonsed" "summonsing") ;
		...
		endeavor_VV_Attempt = variants {} ;
		try_VV_Attempt = mkVV (mkV "try" "tries" "tried" "tried" "trying") ;
		undertake_VV_Attempt = mkVV (mkV "under" IrregEng.take_V) ;

		try_V2_Attempt_means = mkV2 (mkV "try" "tries" "tried" "tried" "trying") ;
		try_VV_Attempt_means = mkVV (mkV "try" "tries" "tried" "tried" "trying") ;

		beg_V_Attempt_suasion = regDuplV "beg" ;
		cajole_V_Attempt_suasion = mkV "cajole" "cajoles" "cajoled" "cajoled" "cajoling" ;
		lobby_V_Attempt_suasion = mkV "lobby" "lobbies" "lobbied" "lobbied" "lobbying" ;
		press_V_Attempt_suasion = mkV "press" "presses" "pressed" "pressed" "pressing" ;
		urge_V_Attempt_suasion = mkV "urge" "urges" "urged" "urged" "urging" ;
		beg_V2_Attempt_suasion = mkV2 (regDuplV "beg") ;
		cajole_V2_Attempt_suasion = mkV2 (mkV "cajole" "cajoles" "cajoled" "cajoled" "cajoling") ;
		exhort_V2_Attempt_suasion = mkV2 (mkV "exhort" "exhorts" "exhorted" "exhorted" "exhorting") ;
		lobby_V2_Attempt_suasion = mkV2 (mkV "lobby" "lobbies" "lobbied" "lobbied" "lobbying") ;
		press_V2_Attempt_suasion = mkV2 (mkV "press" "presses" "pressed" "pressed" "pressing") ;
		urge_V2_Attempt_suasion = mkV2 (mkV "urge" "urges" "urged" "urged" "urging") ;
		advocate_V2_Attempt_suasion = mkV2 (mkV "advocate" "advocates" "advocated" "advocated" "advocating") ;

		attend_V2_Attending = mkV2 (mkV "attend" "attends" "attended" "attended" "attending") ;
		...
		become_V2_Becoming = mkV2 (irregV "become" "became" "become") ;
		end_up_V2_Becoming = mkV2 (partV (mkV "end" "ends" "ended" "ended" "ending") "up") ;
		turn_V2_Becoming = mkV2 (regV "turn") ;
		...
		detach_V_Becoming_detached = mkV "detach" "detaches" "detached" "detached" "detaching" ;
		...
		arch_V2_Body_movement = mkV2 (mkV "arch" "arches" "arched" "arched" "arching") ;
		bat_V2_Body_movement = mkV2 (mkV "bat" "bats" "batted" "batted" "batting") ;
		bend_V2_Body_movement = mkV2 (irregV "bend" "bent" "bent") ;
		blink_V2_Body_movement = mkV2 (mkV "blink" "blinks" "blinked" "blinked" "blinking") ;
		bob_V2_Body_movement = mkV2 (mkV "bob" "bobs" "bobbed" "bobbed" "bobbing") ;
		clap_V2_Body_movement = mkV2 (mkV "clap" "claps" "clapped" "clapped" "clapping") ;
		close_V2_Body_movement = mkV2 (regV "close") ;
		cock_V2_Body_movement = mkV2 (mkV "cock" "cocks" "cocked" "cocked" "cocking") ;
		crane_V2_Body_movement = mkV2 (mkV "crane" "cranes" "craned" "craned" "craning") ;
		crease_V2_Body_movement = mkV2 (mkV "crease" "creases" "creased" "creased" "creasing") ;
		cross_V2_Body_movement = mkV2 (mkV "cross" "crosses" "crossed" "crossed" "crossing") ;
		drop_V2_Body_movement = mkV2 (mkV "drop" "drops" "dropped" "dropped" "dropping") ;
		duck_V2_Body_movement = mkV2 (mkV "duck" "ducks" "ducked" "ducked" "ducking") ;
		flap_V2_Body_movement = mkV2 (mkV "flap" "flaps" "flapped" "flapped" "flapping") ;
		flex_V2_Body_movement = mkV2 (mkV "flex" "flexes" "flexed" "flexed" "flexing") ;
		fling_V2_Body_movement = mkV2 (irregV "fling" "flung" "flung") ;
		flutter_V2_Body_movement = mkV2 (mkV "flutter" "flutters" "fluttered" "fluttered" "fluttering") ;
		gnash_V2_Body_movement = mkV2 (mkV "gnash" "gnashes" "gnashed" "gnashed" "gnashing") ;
		grind_V2_Body_movement = mkV2 (irregV "grind" "ground" "ground") ;
		hang_V2_Body_movement = mkV2 (irregV "hang" "hung" "hung") ;
		jerk_V2_Body_movement = mkV2 (mkV "jerk" "jerks" "jerked" "jerked" "jerking") ;
		jiggle_V2_Body_movement = mkV2 (mkV "jiggle" "jiggles" "jiggled" "jiggled" "jiggling") ;
		lift_V2_Body_movement = mkV2 (mkV "lift" "lifts" "lifted" "lifted" "lifting") ;
		nod_V2_Body_movement = mkV2 (mkV "nod" "nods" "nodded" "nodded" "nodding") ;
		open_V2_Body_movement = mkV2 (mkV "open" "opens" "opened" "opened" "opening") ;
		pout_V2_Body_movement = mkV2 (mkV "pout" "pouts" "pouted" "pouted" "pouting") ;
		pucker_V2_Body_movement = mkV2 (mkV "pucker" "puckers" "puckered" "puckered" "puckering") ;
		purse_V2_Body_movement = mkV2 (mkV "purse" "purses" "pursed" "pursed" "pursing") ;
		roll_V2_Body_movement = mkV2 (mkV "roll" "rolls" "rolled" "rolled" "rolling") ;
		shake_V2_Body_movement = mkV2 (irregV "shake" "shook" "shaken") ;
		shrug_V2_Body_movement = mkV2 (mkV "shrug" "shrugs" "shrugged" "shrugged" "shrugging") ;
		shuffle_V2_Body_movement = mkV2 (mkV "shuffle" "shuffles" "shuffled" "shuffled" "shuffling") ;
		shut_V2_Body_movement = mkV2 (irregDuplV "shut" "shut" "shut") ;
		smack_V2_Body_movement = mkV2 (mkV "smack" "smacks" "smacked" "smacked" "smacking") ;
		stamp_V2_Body_movement = mkV2 (mkV "stamp" "stamps" "stamped" "stamped" "stamping") ;
		stretch_V2_Body_movement = mkV2 (mkV "stretch" "stretches" "stretched" "stretched" "stretching") ;
		swing_V2_Body_movement = mkV2 (irregV "swing" "swung" "swung") ;
		throw_V2_Body_movement = mkV2 (irregV "throw" "threw" "thrown") ;
		toss_V2_Body_movement = mkV2 (mkV "toss" "tosses" "tossed" "tossed" "tossing") ;
		twiddle_V2_Body_movement = mkV2 (mkV "twiddle" "twiddles" "twiddled" "twiddled" "twiddling") ;
		twitch_V2_Body_movement = mkV2 (mkV "twitch" "twitches" "twitched" "twitched" "twitching") ;
		wag_V2_Body_movement = mkV2 (mkV "wag" "wags" "wagged" "wagged" "wagging") ;
		waggle_V2_Body_movement = mkV2 (mkV "waggle" "waggles" "waggled" "waggled" "waggling") ;
		wave_V2_Body_movement = mkV2 (mkV "wave" "waves" "waved" "waved" "waving") ;
		wiggle_V2_Body_movement = mkV2 (mkV "wiggle" "wiggles" "wiggled" "wiggled" "wiggling") ;
		wink_V2_Body_movement = mkV2 (mkV "wink" "winks" "winked" "winked" "winking") ;
		wriggle_V2_Body_movement = mkV2 (mkV "wriggle" "wriggles" "wriggled" "wriggled" "wriggling") ;
		wrinkle_V2_Body_movement = mkV2 (mkV "wrinkle" "wrinkles" "wrinkled" "wrinkled" "wrinkling") ;
		writhe_V2_Body_movement = mkV2 (mkV "writhe" "writhes" "writhed" "writhed" "writhing") ;

		mature_V_Bond_maturation = mkV "mature" "matures" "matured" "matured" "maturing" ;
		...
		botch_V2_Bungling = mkV2 (mkV "botch" "botches" "botched" "botched" "botching") ;
		bungle_V2_Bungling = mkV2 (mkV "bungle" "bungles" "bungled" "bungled" "bungling") ;
		fuck_up_V2_Bungling = mkV2 (partV (mkV "fuck" "fucks" "fucked" "fucked" "fucking") "up") ;
		fumble_V2_Bungling = mkV2 (mkV "fumble" "fumbles" "fumbled" "fumbled" "fumbling") ;
		mess_up_V2_Bungling = mkV2 (partV (mkV "mess" "messes" "messed" "messed" "messing") "up") ;
		...
		class_V2_Categorization = mkV2 (mkV "class" "classes" "classed" "classed" "classing") ;
		classify_V2_Categorization = mkV2 (mkV "classify" "classifies" "classified" "classified" "classifying") ;
		conceive_V2_Categorization = mkV2 (mkV "conceive" "conceives" "conceived" "conceived" "conceiving") ;
		consider_V2_Categorization = mkV2 (mkV "consider" "considers" "considered" "considered" "considering") ;
		construe_V2_Categorization = mkV2 (mkV "construe" "construes" "construed" "construed" "construing") ;
		count_V2_Categorization = mkV2 (regV "count") ;
		interpret_V2_Categorization = mkV2 (mkV "interpret" "interprets" "interpreted" "interpreted" "interpreting") ;
		peg_V2_Categorization = mkV2 (mkV "peg" "pegs" "pegged" "pegged" "pegging") ;
		perceive_V2_Categorization = mkV2 (mkV "perceive" "perceives" "perceived" "perceived" "perceiving") ;
		pigeonhole_V2_Categorization = mkV2 (mkV "pigeonhole" "pigeonholes" "pigeonholed" "pigeonholed" "pigeonholing") ;
		regard_V2_Categorization = mkV2 (mkV "regard" "regards" "regarded" "regarded" "regarding") ;
		stereotype_V2_Categorization = mkV2 (mkV "stereotype" "stereotypes" "stereotyped" "stereotyped" "stereotyping") ;
		understand_V2_Categorization = mkV2 (irregV "understand" "understood" "understood") ;
		...
		splatter_V2_Cause_fluidic_motion = variants {} ;
		...
		stab_V_Cause_harm = regDuplV "stab" ;
		...
		stab_V2_Cause_harm = mkV2 (regDuplV "stab") ;
		...
		chill_V2_Cause_temperature_change = mkV2 (mkV "chill" "chills" "chilled" "chilled" "chilling") ;
		cool_V2_Cause_temperature_change = mkV2 (mkV "cool" "cools" "cooled" "cooled" "cooling") ;
		heat_V2_Cause_temperature_change = mkV2 (mkV "heat" "heats" "heated" "heated" "heating") ;
		refrigerate_V2_Cause_temperature_change = mkV2 (mkV "refrigerate" "refrigerates" "refrigerated" "refrigerated" "refrigerating") ;
		reheat_V2_Cause_temperature_change = variants {} ;
		warm_V2_Cause_temperature_change = mkV2 (mkV "warm" "warms" "warmed" "warmed" "warming") ;
		...
		moisturize_V2_Cause_to_be_wet = variants {} ;
		...
		disappear_V2_Ceasing_to_be = mkV2 (mkV "disappear" "disappears" "disappeared" "disappeared" "disappearing") ;
		...
		elect_V2_Change_of_leadership = mkV2 (mkV "elect") ;
		dethrone_V2_Change_of_leadership = mkV2 (mkV "dethrone" "dethrones" "dethroned" "dethroned" "dethroning") ;
		oust_V2_Change_of_leadership = mkV2 (mkV "oust" "ousts" "ousted" "ousted" "ousting") ;
		overthrow_V2_Change_of_leadership = mkV2 (irregV "overthrow" "overthrew" "overthrown") ;
		...
		sublime_V_Change_of_phase = variants {} ;
		...
		lose_V2_Change_of_quantity_of_possession = mkV2 (irregV "lose" "lost" "lost") ;
		...
		opt_VV_Choosing = mkVV (mkV "opt" "opts" "opted" "opted" "opting") ;
		...
		collude_V_Collaboration = variants {} ;
		...
		throng_V_Come_together = mkV "throng" "throngs" "thronged" "thronged" "thronging" ;
		...
		charge_V2_Commerce_collect = mkV2 (mkV "charge" "charges" "charged" "charged" "charging") ;

		disburse_V2_Commerce_pay = mkV2 (mkV "disburse" "disburses" "disbursed" "disbursed" "disbursing") ;
		pay_V2_Commerce_pay = mkV2 (irregV "pay" "paid" "paid") ;
		...
		phone_V2_Communication_means = mkV2 (mkV "phone" "phones" "phoned" "phoned" "phoning") ;
		telex_V2_Communication_means = variants {} ;

		bark_V2_Communication_noise = mkV2 (mkV "bark" "barks" "barked" "barked" "barking") ;
		bawl_V2_Communication_noise = mkV2 (mkV "bawl" "bawls" "bawled" "bawled" "bawling") ;
		bellow_V2_Communication_noise = mkV2 (mkV "bellow" "bellows" "bellowed" "bellowed" "bellowing") ;
		bray_V2_Communication_noise = mkV2 (mkV "bray" "brays" "brayed" "brayed" "braying") ;
		burble_V2_Communication_noise = mkV2 (mkV "burble" "burbles" "burbled" "burbled" "burbling") ;
		chuckle_V2_Communication_noise = mkV2 (mkV "chuckle" "chuckles" "chuckled" "chuckled" "chuckling") ;
		coo_V2_Communication_noise = mkV2 (mkV "coo" "coos" "cooed" "cooed" "cooing") ;
		croak_V2_Communication_noise = mkV2 (mkV "croak" "croaks" "croaked" "croaked" "croaking") ;
		crow_V2_Communication_noise = mkV2 (mkV "crow" "crows" "crowed" "crowed" "crowing") ;
		cry_V2_Communication_noise = mkV2 (mkV "cry" "cries" "cried" "cried" "crying") ;
		gasp_V2_Communication_noise = mkV2 (mkV "gasp" "gasps" "gasped" "gasped" "gasping") ;
		groan_V2_Communication_noise = mkV2 (mkV "groan" "groans" "groaned" "groaned" "groaning") ;
		growl_V2_Communication_noise = mkV2 (mkV "growl" "growls" "growled" "growled" "growling") ;
		grunt_V2_Communication_noise = mkV2 (mkV "grunt" "grunts" "grunted" "grunted" "grunting") ;
		gurgle_V2_Communication_noise = mkV2 (mkV "gurgle" "gurgles" "gurgled" "gurgled" "gurgling") ;
		hiss_V2_Communication_noise = mkV2 (mkV "hiss" "hisses" "hissed" "hissed" "hissing") ;
		howl_V2_Communication_noise = mkV2 (mkV "howl" "howls" "howled" "howled" "howling") ;
		murmur_V2_Communication_noise = mkV2 (mkV "murmur" "murmurs" "murmured" "murmured" "murmuring") ;
		rap_V2_Communication_noise = mkV2 (mkV "rap" "raps" "rapped" "rapped" "rapping") ;
		rasp_V2_Communication_noise = mkV2 (mkV "rasp" "rasps" "rasped" "rasped" "rasping") ;
		rattle_V2_Communication_noise = mkV2 (mkV "rattle" "rattles" "rattled" "rattled" "rattling") ;
		roar_V2_Communication_noise = mkV2 (mkV "roar" "roars" "roared" "roared" "roaring") ;
		rumble_V2_Communication_noise = mkV2 (mkV "rumble" "rumbles" "rumbled" "rumbled" "rumbling") ;
		scream_V2_Communication_noise = mkV2 (mkV "scream" "screams" "screamed" "screamed" "screaming") ;
		screech_V2_Communication_noise = mkV2 (mkV "screech" "screeches" "screeched" "screeched" "screeching") ;
		shriek_V2_Communication_noise = mkV2 (mkV "shriek" "shrieks" "shrieked" "shrieked" "shrieking") ;
		snarl_V2_Communication_noise = mkV2 (mkV "snarl" "snarls" "snarled" "snarled" "snarling") ;
		splutter_V2_Communication_noise = mkV2 (mkV "splutter" "splutters" "spluttered" "spluttered" "spluttering") ;
		squeak_V2_Communication_noise = mkV2 (mkV "squeak" "squeaks" "squeaked" "squeaked" "squeaking") ;
		squeal_V2_Communication_noise = mkV2 (mkV "squeal" "squeals" "squealed" "squealed" "squealing") ;
		thunder_V2_Communication_noise = mkV2 (mkV "thunder" "thunders" "thundered" "thundered" "thundering") ;
		trumpet_V2_Communication_noise = mkV2 (mkV "trumpet" "trumpets" "trumpeted" "trumpeted" "trumpeting") ;
		wail_V2_Communication_noise = mkV2 (mkV "wail" "wails" "wailed" "wailed" "wailing") ;
		wheeze_V2_Communication_noise = mkV2 (mkV "wheeze" "wheezes" "wheezed" "wheezed" "wheezing") ;
		whine_V2_Communication_noise = mkV2 (mkV "whine" "whines" "whined" "whined" "whining") ;
		whoop_V2_Communication_noise = mkV2 (mkV "whoop" "whoops" "whooped" "whooped" "whooping") ;
		yell_V2_Communication_noise = mkV2 (mkV "yell" "yells" "yelled" "yelled" "yelling") ;
		...
		whinge_V_Complaining = variants {} ;
		lament_V2_Complaining = mkV2 (mkV "lament" "laments" "lamented" "lamented" "lamenting") ;
		...
		depends_V_Contingency = variants {} ;
		...
		make_V_Cooking_creation = irregV "make" "made" "made" ;
		...
		confer_V_Discussion = mkV "confer" "confers" "conferred" "conferred" "conferring" ;
		debate_V_Discussion = mkV "debate" "debates" "debated" "debated" "debating" ;
		discuss_V_Discussion = mkV "discuss" "discusses" "discussed" "discussed" "discussing" ;
		parley_V_Discussion = mkV "parley" "parleys" "parleyed" "parleyed" "parleying" ;
		...
		characterize_V2_Distinctiveness = mkV2 (mkV "characterize" "characterizes" "characterized" "characterized" "characterizing") ;
		...
		copy_V2_Duplication = mkV2 (mkV "copy" "copies" "copied" "copied" "copying") ;
		duplicate_V2_Duplication = mkV2 (mkV "duplicate" "duplicates" "duplicated" "duplicated" "duplicating") ;
		photocopy_V2_Duplication = mkV2 (mkV "photocopy" "photocopies" "photocopied" "photocopied" "photocopying") ;
		reduplicate_V2_Duplication = mkV2 (mkV "reduplicate" "reduplicates" "reduplicated" "reduplicated" "reduplicating") ;
		replicate_V2_Duplication = mkV2 (mkV "replicate") ;
		reproduce_V2_Duplication = mkV2 (mkV "reproduce" "reproduces" "reproduced" "reproduced" "reproducing") ;

		last_V_Duration_relation = mkV "last" "lasts" "lasted" "lasted" "lasting" ;
		...
		school_V2V_Education_teaching = mkV2V (mkV "school" "schools" "schooled" "schooled" "schooling") noPrep to_Prep ;
		train_V2V_Education_teaching = mkV2V (mkV "train" "trains" "trained" "trained" "training") noPrep to_Prep ;
		...
		lose_sleep_V_Emotion_active = variants {} ;
		...
		smolder_V_Emotion_heat = variants {} ;
		...
		encounter_V2_Encounter = mkV2 (mkV "encounter" "encounters" "encountered" "encountered" "encountering") ;
		...
		give_the_slip_V2_Evading = variants {} ;
		...
		perspire_V_Excreting = mkV "perspire" "perspires" "perspired" "perspired" "perspiring" ;
		sweat_V_Excreting = mkV "sweat" "sweats" "sweated" "sweated" "sweating" ;
		...
		guillotine_V2_Execution = mkV2 (mkV "guillotine" "guillotines" "guillotined" "guillotined" "guillotining") ;
		...
		delight_V_Experiencer_focus = mkV "delight" "delights" "delighted" "delighted" "delighting" ;
		despair_V_Experiencer_focus = mkV "despair" "despairs" "despaired" "despaired" "despairing" ;
		fear_V_Experiencer_focus = regV "fear" ;
		grieve_V_Experiencer_focus = mkV "grieve" "grieves" "grieved" "grieved" "grieving" ;
		like_V_Experiencer_focus = regV "like" ;
		mourn_V_Experiencer_focus = mkV "mourn" "mourns" "mourned" "mourned" "mourning" ;
		resent_V_Experiencer_focus = mkV "resent" "resents" "resented" "resented" "resenting" ;
		...
		faze_V2_Experiencer_obj = variants {} ;
		...
		traumatize_V2_Experiencer_obj = variants {} ;
		...
		wow_V2_Experiencer_obj = variants {} ;
		...
		put_into_words_V2_Expressing_publicly = variants {} ;
		...
		faint_V_Fall_asleep = mkV "faint" "faints" "fainted" "fainted" "fainting" ;
		...
		wallpaper_V2_Filling = variants {} ;
		wrap_V2_Filling = mkV2 (mkV "wrap" "wraps" "wrapped" "wrapped" "wrapping") ;
		panel_V2_Filling = mkV2 (mkV "panel" "panels" "panelled" "panelled" "panelling") ;
		...
		tie_the_knot_V_Forming_relationships = variants {} ;
		...
		front_V_Front_for = mkV "front" "fronts" "fronted" "fronted" "fronting" ;

		husband_V2_Frugality = mkV2 (mkV "husband" "husbands" "husbanded" "husbanded" "husbanding") ;
		squander_V2_Frugality = mkV2 (mkV "squander" "squanders" "squandered" "squandered" "squandering") ;
		...
		sign_on_V_Get_a_job = partV (mkV "sign" "signs" "signed" "signed" "signing") "on" ;
		...
		head_out_V_Getting_underway = partV (mkV "head" "heads" "headed" "headed" "heading") "out" ;

		rise_V_Getting_up = irregV "rise" "rose" "risen" ;
		...
		acquiesce_V_Giving_in = mkV "acquiesce" "acquiesces" "acquiesced" "acquiesced" "acquiescing" ;
		...
		allow_V2_Grant_permission = mkV2 (mkV "allow" "allows" "allowed" "allowed" "allowing") ;
		approve_V2_Grant_permission = mkV2 (mkV "approve" "approves" "approved" "approved" "approving") ;
		authorize_V2_Grant_permission = mkV2 (mkV "authorize" "authorizes" "authorized" "authorized" "authorizing") ;
		greenlight_V2_Grant_permission = variants {} ;
		permit_V2_Grant_permission = mkV2 (mkV "permit" "permits" "permitted" "permitted" "permitting") ;
		sanction_V2_Grant_permission = mkV2 (mkV "sanction" "sanctions" "sanctioned" "sanctioned" "sanctioning") ;
		...
		plait_V_Grooming = mkV "plait" "plaits" "plaited" "plaited" "plaiting" ;
		...
		moisturize_V2_Grooming = variants {} ;
		...
		grow_V2_Growing_food = mkV2 (irregV "grow" "grew" "grown") ;
		raise_V2_Growing_food = mkV2 (mkV "raise" "raises" "raised" "raised" "raising") ;

		curl_V_Hair_configuration = mkV "curl" "curls" "curled" "curled" "curling" ;

		halt_V_Halt = mkV "halt" "halts" "halted" "halted" "halting" ;
		stop_V_Halt = regDuplV "stop" ;

		demand_V2_Have_as_requirement = mkV2 (mkV "demand" "demands" "demanded" "demanded" "demanding") ;

		translate_V_Have_as_translation_equivalent = mkV "translate" "translates" "translated" "translated" "translating" ;
		...
		herald_V2_Heralding = mkV2 (mkV "herald" "heralds" "heralded" "heralded" "heralding") ;
		...
		shoot_V2_Hit_target = mkV2 (irregV "shoot" "shot" "shot") ;

		hold_off_VV_Holding_off_on = mkVV (partV (irregV "hold" "held" "held") "off") ;
		...
		catch_V2_Hunting_success_or_failure = mkV2 (irregV "catch" "caught" "caught") ;
		...
		drag_V_Ingest_substance = mkV "drag" "drags" "dragged" "dragged" "dragging" ;
		inject_V_Ingest_substance = mkV "inject" "injects" "injected" "injected" "injecting" ;
		puff_V_Ingest_substance = mkV "puff" "puffs" "puffed" "puffed" "puffing" ;
		pull_V_Ingest_substance = regV "pull" ;
		shoot_V_Ingest_substance = irregV "shoot" "shot" "shot" ;
		smoke_V_Ingest_substance = mkV "smoke" "smokes" "smoked" "smoked" "smoking" ;
		...
		slurp_V_Ingestion = variants {} ;
		snack_V_Ingestion = variants {} ;
		...
		proofread_V2_Inspecting = variants {} ;
		...
		do_something_V_Intentionally_affect = variants {} ;
		...
		charge_V_Judgment_communication = mkV "charge" "charges" "charged" "charged" "charging" ;
		condemn_V_Judgment_communication = mkV "condemn" "condemns" "condemned" "condemned" "condemning" ;
		criticize_V_Judgment_communication = mkV "criticize" "criticizes" "criticized" "criticized" "criticizing" ;
		deride_V_Judgment_communication = mkV "deride" "derides" "derided" "derided" "deriding" ;
		gibe_V_Judgment_communication = mkV "gibe" "gibes" "gibed" "gibed" "gibing" ;
		remonstrate_V_Judgment_communication = mkV "remonstrate" "remonstrates" "remonstrated" "remonstrated" "remonstrating" ;
		scoff_V_Judgment_communication = mkV "scoff" "scoffs" "scoffed" "scoffed" "scoffing" ;
		...
		take_to_task_V2_Judgment_direct_address = variants {} ;
		...
		brand_V2_Labeling = mkV2 (mkV "brand" "brands" "branded" "branded" "branding") ;
		label_V2_Labeling = mkV2 (mkV "label" (variants {"labelled"; "labeled"})) ;
		...
		find_V2_Locating = mkV2 (irregV "find" "found" "found") ;
		...
		abut_V2_Locative_relation = mkV2 (mkV "abut" "abuts" "abutted" "abutted" "abutting") ;
		adjoin_V2_Locative_relation = mkV2 (mkV "adjoin" "adjoins" "adjoined" "adjoined" "adjoining") ;

		lose_V2_Losing = mkV2 (irregV "lose" "lost" "lost") ;

		lose_V2_Losing_someone = mkV2 (irregV "lose" "lost" "lost") ;

		agree_V_Make_agreement_on_action = mkV "agree" ;

		link_V2_Make_cognitive_connection = mkV2 (mkV "link" "links" "linked" "linked" "linking") ;
		...
		loop_V2_Manipulate_into_shape = mkV2 (mkV "loop" "loops" "looped" "looped" "looping") ;
		...
		grab_hold_V_Manipulation = variants {} ;
		...
		rub_V2_Manipulation = mkV2 (regDuplV "rub") ;
		...
		commit_to_memory_V2_Memorization = variants {} ;
		memorise_V2_Memorization = variants {} ;
		...
		travel_V_Motion = regDuplV "travel" ;
		...
		clink_V_Motion_noise = mkV "clink" "clinks" "clinked" "clinked" "clinking" ;
		...
		crunch_V_Motion_noise = mkV "crunch" "crunches" "crunched" "crunched" "crunching" ;
		fizz_V_Motion_noise = mkV "fizz" "fizzes" "fizzed" "fizzed" "fizzing" ;
		...
		ping_V_Motion_noise = mkV "ping" "pings" "pinged" "pinged" "pinging" ;
		purr_V_Motion_noise = mkV "purr" "purrs" "purred" "purred" "purring" ;
		...
		splash_V_Motion_noise = mkV "splash" "splashes" "splashed" "splashed" "splashing" ;
		splutter_V_Motion_noise = mkV "splutter" "splutters" "spluttered" "spluttered" "spluttering" ;
		...
		thud_V_Motion_noise = mkV "thud" "thuds" "thudded" "thudded" "thudding" ;
		thump_V_Motion_noise = mkV "thump" "thumps" "thumped" "thumped" "thumping" ;
		thunder_V_Motion_noise = mkV "thunder" "thunders" "thundered" "thundered" "thundering" ;
		wheeze_V_Motion_noise = mkV "wheeze" "wheezes" "wheezed" "wheezed" "wheezing" ;
		whine_V_Motion_noise = mkV "whine" "whines" "whined" "whined" "whining" ;
		whir_V_Motion_noise = mkV "whir" "whirs" "whirred" "whirred" "whirring" ;
		zing_V_Motion_noise = variants {} ;
		chug_V2_Motion_noise = mkV2 (mkV "chug" "chugs" "chugged" "chugged" "chugging") ;
		clang_V2_Motion_noise = mkV2 (mkV "clang" "clangs" "clanged" "clanged" "clanging") ;
		clatter_V2_Motion_noise = mkV2 (mkV "clatter" "clatters" "clattered" "clattered" "clattering") ;
		crunch_V2_Motion_noise = mkV2 (mkV "crunch" "crunches" "crunched" "crunched" "crunching") ;
		fizz_V2_Motion_noise = mkV2 (mkV "fizz" "fizzes" "fizzed" "fizzed" "fizzing") ;
		putter_V2_Motion_noise = mkV2 (mkV "putter" "putters" "puttered" "puttered" "puttering") ;
		thunder_V2_Motion_noise = mkV2 (mkV "thunder" "thunders" "thundered" "thundered" "thundering") ;
		whine_V2_Motion_noise = mkV2 (mkV "whine" "whines" "whined" "whined" "whining") ;
		whir_V2_Motion_noise = mkV2 (mkV "whir" "whirs" "whirred" "whirred" "whirring") ;
		...
		decay_V2_Nuclear_process = mkV2 (mkV "decay" "decays" "decayed" "decayed" "decaying") ;
		...
		offer_V2_Offering = mkV2 (mkV "offer" "offers" "offered" "offered" "offering") ;
		...
		caravan_V_Operate_vehicle = variants {} ;
		...
		bear_V_Path_shape = irregV "bear" "bore" "born" ;
		edge_V_Path_shape = mkV "edge" "edges" "edged" "edged" "edging" ;
		exit_V_Path_shape = mkV "exit" "exits" "exited" "exited" "exiting" ;
		traverse_V_Path_shape = mkV "traverse" "traverses" "traversed" "traversed" "traversing" ;
		veer_V_Path_shape = mkV "veer" "veers" "veered" "veered" "veering" ;
		crisscross_V2_Path_shape = mkV2 (mkV "crisscross" "crisscrosses" "crisscrossed" "crisscrossed" "crisscrossing") ;

		attend_V_Perception_active = mkV "attend" "attends" "attended" "attended" "attending" ;
		eavesdrop_V_Perception_active = mkV "eavesdrop" "eavesdrops" "eavesdropped" "eavesdropped" "eavesdropping" ;
		feel_V_Perception_active = irregV "feel" "felt" "felt" ;
		gaze_V_Perception_active = mkV "gaze" "gazes" "gazed" "gazed" "gazing" ;
		glance_V_Perception_active = mkV "glance" "glances" "glanced" "glanced" "glancing" ;
		listen_V_Perception_active = mkV "listen" "listened" ;
		look_V_Perception_active = mkV "look" "looks" "looked" "looked" "looking" ;
		peek_V_Perception_active = mkV "peek" "peeks" "peeked" "peeked" "peeking" ;
		peep_V_Perception_active = mkV "peep" "peeps" "peeped" "peeped" "peeping" ;
		peer_V_Perception_active = mkV "peer" "peers" "peered" "peered" "peering" ;
		smell_V_Perception_active = regV "smell" ;
		sniff_V_Perception_active = mkV "sniff" "sniffs" "sniffed" "sniffed" "sniffing" ;
		spy_V_Perception_active = mkV "spy" "spies" "spied" "spied" "spying" ;
		stare_V_Perception_active = mkV "stare" "stares" "stared" "stared" "staring" ;
		watch_V_Perception_active = regV "watch" ;
		palpate_V_Perception_active = variants {} ;
		admire_V2_Perception_active = mkV2 (mkV "admire" "admires" "admired" "admired" "admiring") ;
		feel_V2_Perception_active = mkV2 (irregV "feel" "felt" "felt") ;
		look_V2_Perception_active = mkV2 (mkV "look" "looks" "looked" "looked" "looking") ;
		palpate_V2_Perception_active = variants {} ;
		savor_V2_Perception_active = variants {} ;
		smell_V2_Perception_active = mkV2 (regV "smell") ;
		sniff_V2_Perception_active = mkV2 (mkV "sniff" "sniffs" "sniffed" "sniffed" "sniffing") ;
		spy_V2_Perception_active = mkV2 (mkV "spy" "spies" "spied" "spied" "spying") ;
		stare_V2_Perception_active = mkV2 (mkV "stare" "stares" "stared" "stared" "staring") ;
		taste_V2_Perception_active = mkV2 (mkV "taste" "tastes" "tasted" "tasted" "tasting") ;
		view_V2_Perception_active = mkV2 (mkV "view" "views" "viewed" "viewed" "viewing") ;
		watch_V2_Perception_active = mkV2 (regV "watch") ;
		...
		widow_V_Personal_relationship = variants {} ;
		...
		seeing_V2_Personal_relationship = variants {} ;

		hijack_V2_Piracy = mkV2 (mkV "hijack" "hijacks" "hijacked" "hijacked" "hijacking") ;

		place_weight_V_Place_weight_on = variants {} ;

		archive_V2_Placing = variants {} ;
		...
		rub_V2_Placing = mkV2 (regDuplV "rub") ;
		...
		forecast_V2_Predicting = mkV2 (mkV "forecast" "forecasts" "forecasted" "forecasted" "forecasting") ;
		foretell_V2_Predicting = mkV2 (mkV "fore" IrregEng.tell_V) ;
		predict_V2_Predicting = mkV2 (mkV "predict" "predicts" "predicted" "predicted" "predicting") ;
		prophesy_V2_Predicting = mkV2 (mkV "prophesy" "prophesies" "prophesied" "prophesied" "prophesying") ;
		forecast_VQ_Predicting = mkVQ (mkV "forecast" "forecasts" "forecasted" "forecasted" "forecasting") ;
		foretell_VQ_Predicting = mkVQ (mkV "fore" IrregEng.tell_V) ;
		predict_VQ_Predicting = mkVQ (mkV "predict" "predicts" "predicted" "predicted" "predicting") ;
		prophesy_VQ_Predicting = mkVQ (mkV "prophesy" "prophesies" "prophesied" "prophesied" "prophesying") ;
		forecast_VS_Predicting = mkVS (mkV "forecast" "forecasts" "forecasted" "forecasted" "forecasting") ;
		foretell_VS_Predicting = mkVS (mkV "fore" IrregEng.tell_V) ;
		predict_VS_Predicting = mkVS (mkV "predict" "predicts" "predicted" "predicted" "predicting") ;
		prophesy_VS_Predicting = mkVS (mkV "prophesy" "prophesies" "prophesied" "prophesied" "prophesying") ;
		...
		equivocate_V_Prevarication = variants {} ;
		...
		resume_V_Process_resume = mkV "resume" "resumes" "resumed" "resumed" "resuming" ;
		...
		reprocess_V2_Processing_materials = variants {} ;
		stain_V2_Processing_materials = mkV2 (mkV "stain" "stains" "stained" "stained" "staining") ;
		galvanize_V2_Processing_materials = mkV2 (mkV "galvanize" "galvanizes" "galvanized" "galvanized" "galvanizing") ;
		treat_V2_Processing_materials = mkV2 (mkV "treat" "treats" "treated" "treated" "treating") ;

		burgeon_V_Progress = mkV "burgeon" "burgeons" "burgeoned" "burgeoned" "burgeoning" ;
		mature_V_Progress = mkV "mature" "matures" "matured" "matured" "maturing" ;

		prohibit_V2_Prohibiting = mkV2 (mkV "prohibit" "prohibits" "prohibited" "prohibited" "prohibiting") ;
		...
		quit_V2_Quitting = mkV2 (irregDuplV "quit" "quit" "quit") ;
		resign_V2_Quitting = mkV2 (mkV "resign" "resigns" "resigned" "resigned" "resigning") ;
		...
		heal_V2_Recovery = mkV2 (mkV "heal" "heals" "healed" "healed" "healing") ;

		redirect_V2_Redirecting = variants {} ;
		...
		invigorate_V2_Rejuvenation = mkV2 (mkV "invigorate" "invigorates" "invigorated" "invigorated" "invigorating") ;
		...
		release_V2_Releasing = mkV2 (mkV "release" "releases" "released" "released" "releasing") ;

		count_V_Reliance = regV "count" ;
		depend_V_Reliance = mkV "depend" "depends" "depended" "depended" "depending" ;
		rely_V_Reliance = mkV "rely" "relies" "relied" "relied" "relying" ;
		...
		be_symbol_V_Representing = variants {} ;

		ask_V2_Request = mkV2 (regV "ask") ;
		beg_V2_Request = mkV2 (regDuplV "beg") ;
		...
		tell_V2_Request = mkV2 (irregV "tell" "told" "told") ;
		...
		beg_V2V_Request = mkV2V (regDuplV "beg") noPrep to_Prep ;
		...
		ask_VS_Request = mkVS (regV "ask") ;
		beg_VS_Request = mkVS (regDuplV "beg") ;
		beseech_VS_Request = mkVS (mkV "beseech" "beseeches" "beseeched" "beseeched" "beseeching") ;
		command_VS_Request = mkVS (mkV "command" "commands" "commanded" "commanded" "commanding") ;
		demand_VS_Request = mkVS (mkV "demand" "demands" "demanded" "demanded" "demanding") ;
		entreat_VS_Request = mkVS (mkV "entreat" "entreats" "entreated" "entreated" "entreating") ;
		implore_VS_Request = mkVS (mkV "implore" "implores" "implored" "implored" "imploring") ;
		order_VS_Request = mkVS (mkV "order" "orders" "ordered" "ordered" "ordering") ;
		plead_VS_Request = mkVS (irregV "plead" "pled" "pled") ;
		request_VS_Request = mkVS (mkV "request" "requests" "requested" "requested" "requesting") ;
		urge_VS_Request = mkVS (mkV "urge" "urges" "urged" "urged" "urging") ;

		research_V_Research = mkV "research" "researches" "researched" "researched" "researching" ;

		pulp_V_Reshaping = mkV "pulp" "pulps" "pulped" "pulped" "pulping" ;
		squash_V_Reshaping = mkV "squash" "squashes" "squashed" "squashed" "squashing" ;
		...
		come_clean_V_Reveal_secret = variants {} ;
		...
		spill_beans_V_Reveal_secret = variants {} ;
		...
		admit_VS_Reveal_secret = mkVS (mkV "admit" "admits" "admitted" "admitted" "admitting") ;
		confide_VS_Reveal_secret = mkVS (mkV "confide" "confides" "confided" "confided" "confiding") ;
		disclose_VS_Reveal_secret = mkVS (mkV "disclose" "discloses" "disclosed" "disclosed" "disclosing") ;
		divulge_VS_Reveal_secret = mkVS (mkV "divulge" "divulges" "divulged" "divulged" "divulging") ;

		get_back_V_Revenge = partV (irregDuplV "get" "got" "gotten") "back" ;
		get_even_V_Revenge = variants {} ;
		...
		hitchhike_V_Ride_vehicle = mkV "hitchhike" "hitchhikes" "hitchhiked" "hitchhiked" "hitchhiking" ;
		jet_V_Ride_vehicle = mkV "jet" "jets" "jetted" "jetted" "jetting" ;
		coast_V_Ride_vehicle = mkV "coast" "coasts" "coasted" "coasted" "coasting" ;
		taxi_V_Ride_vehicle = mkV "taxi" "taxis" "taxied" "taxied" "taxiing" ;
		...
		baptize_V_Rite = mkV "baptize" "baptizes" "baptized" "baptized" "baptizing" ;
		christen_V_Rite = mkV "christen" "christens" "christened" "christened" "christening" ;
		...
		satisfy_V2_Satisfying = mkV2 (mkV "satisfy" "satisfies" "satisfied" "satisfied" "satisfying") ;
		...
		analyse_V_Scrutiny = mkV "analyse" "analyses" "analysed" "analysed" "analysing" ;
		look_V_Scrutiny = mkV "look" "looks" "looked" "looked" "looking" ;
		probe_V_Scrutiny = mkV "probe" "probes" "probed" "probed" "probing" ;
		scan_V_Scrutiny = mkV "scan" "scans" "scanned" "scanned" "scanning" ;
		scout_V_Scrutiny = mkV "scout" "scouts" "scouted" "scouted" "scouting" ;
		search_V_Scrutiny = mkV "search" "searches" "searched" "searched" "searching" ;
		skim_V_Scrutiny = mkV "skim" "skims" "skimmed" "skimmed" "skimming" ;
		assay_V2_Scrutiny = mkV2 (mkV "assay" "assays" "assayed" "assayed" "assaying") ;
		investigate_V2_Scrutiny = mkV2 (mkV "investigate" "investigates" "investigated" "investigated" "investigating") ;
		peruse_V2_Scrutiny = mkV2 (mkV "peruse" "peruses" "perused" "perused" "perusing") ;
		probe_V2_Scrutiny = mkV2 (mkV "probe" "probes" "probed" "probed" "probing") ;
		scan_V2_Scrutiny = mkV2 (mkV "scan" "scans" "scanned" "scanned" "scanning") ;
		scout_V2_Scrutiny = mkV2 (mkV "scout" "scouts" "scouted" "scouted" "scouting") ;
		scrutinize_V2_Scrutiny = mkV2 (mkV "scrutinize" "scrutinizes" "scrutinized" "scrutinized" "scrutinizing") ;
		search_V2_Scrutiny = mkV2 (mkV "search" "searches" "searched" "searched" "searching") ;
		study_V2_Scrutiny = mkV2 (mkV "study" "studies" "studied" "studied" "studying") ;
		survey_V2_Scrutiny = mkV2 (mkV "survey" "surveys" "surveyed" "surveyed" "surveying") ;
		skim_V2_Scrutiny = mkV2 (mkV "skim" "skims" "skimmed" "skimmed" "skimming") ;
		...
		sleepwalk_V_Self_motion = variants {} ;
		...
		set_fire_to_V2_Setting_fire = variants {} ;
		...
		cooccur_V_Simultaneity = variants {} ;

		catnap_V_Sleep = variants {} ;
		...
		explain_V2_Statement = mkV2 (mkV "explain" "explains" "explained" "explained" "explaining") ;
		...
		convince_V2S_Suasion = mkV2S (mkV "convince" "convinces" "convinced" "convinced" "convincing") noPrep ;
		persuade_V2S_Suasion = mkV2S (mkV "persuade" "persuades" "persuaded" "persuaded" "persuading") noPrep ;
		...
		do_the_trick_V_Successful_action = variants {} ;
		...
		suspect_V2_Suspicion = mkV2 (mkV "suspect" "suspects" "suspected" "suspected" "suspecting") ;
		...
		oppose_V2_Taking_sides = mkV2 (mkV "oppose" "opposes" "opposed" "opposed" "opposing") ;

		try_V2_Tasting = mkV2 (mkV "try" "tries" "tried" "tried" "trying") ;
		...
		overnight_V_Temporary_stay = variants {} ;
		...
		room_V2_Temporary_stay = mkV2 (mkV "room" "rooms" "roomed" "roomed" "rooming") ;

		author_V2_Text_creation = variants {} ;
		...
		say_VS_Text_creation = mkVS (irregV "say" "said" "said") ;
		...
		tolerate_V_Tolerating = mkV "tolerate" "tolerates" "tolerated" "tolerated" "tolerating" ;

		address_V_Topic = mkV "address" "addresses" "addressed" "addressed" "addressing" ;
		cover_V_Topic = mkV "cover" "covers" "covered" "covered" "covering" ;
		discuss_V_Topic = mkV "discuss" "discusses" "discussed" "discussed" "discussing" ;
		...
		travel_V_Travel = regDuplV "travel" ;
		...
		ascend_V2_Traversing = mkV2 (mkV "ascend" "ascends" "ascended" "ascended" "ascending") ;
		circle_V2_Traversing = mkV2 (mkV "circle" "circles" "circled" "circled" "circling") ;
		cross_V2_Traversing = mkV2 (mkV "cross" "crosses" "crossed" "crossed" "crossing") ;
		descend_V2_Traversing = mkV2 (mkV "descend" "descends" "descended" "descended" "descending") ;
		mount_V2_Traversing = mkV2 (mkV "mount" "mounts" "mounted" "mounted" "mounting") ;
		skirt_V2_Traversing = mkV2 (mkV "skirt" "skirts" "skirted" "skirted" "skirting") ;
		traverse_V2_Traversing = mkV2 (mkV "traverse" "traverses" "traversed" "traversed" "traversing") ;
		...
		certify_V2_Verification = mkV2 (mkV "certify" "certifies" "certified" "certified" "certifying") ;
		confirm_V2_Verification = mkV2 (mkV "confirm" "confirms" "confirmed" "confirmed" "confirming") ;
		identify_V2_Verification = mkV2 (mkV "identify" "identifies" "identified" "identified" "identifying") ;
		verify_V2_Verification = mkV2 (mkV "verify" "verifies" "verified" "verified" "verifying") ;
		certify_VS_Verification = mkVS (mkV "certify" "certifies" "certified" "certified" "certifying") ;
		confirm_VS_Verification = mkVS (mkV "confirm" "confirms" "confirmed" "confirmed" "confirming") ;
		identify_VS_Verification = mkVS (mkV "identify" "identifies" "identified" "identified" "identifying") ;
		verify_VS_Verification = mkVS (mkV "verify" "verifies" "verified" "verified" "verifying") ;

		visit_V2_Visiting = mkV2 (mkV "visit" "visits" "visited" "visited" "visiting") ;
