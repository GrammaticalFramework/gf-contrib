abstract TargetsSweAbs = Cat ** {
	...
	fun
		...
		glömma_V2_Abandonment : V2 ; -- <Agent>[Läkare] [GLÖMDE KVAR] <Theme>[kompress]
		...
		bereda_V_Activity_prepare : V ; -- <Agent>[De politiska motståndarna] får [BEREDA SIG] <Activity>[på att möta ett tuffare Miljöparti]
		...
		ge_VV_Activity_start : VV ; -- <Agent>[jag] [GE MIG PÅ] <Activity>[att tillverka ett eget mönster]
		...
		lägga_V2_Activity_stop : V2 ; -- <Agent>[Nimbus] beslöt [LÄGGA NER] <Activity>[sin tillverkning]
		stoppa_V2_Activity_stop : V2 ; -- <Agent>[inrikesministeriet] [STOPPADE] <Activity>[sändningarna]
		ställa_V2_Activity_stop : V2 ; -- <Agent>[GM] börjar [STÄLLA IN] <Activity>[betalningar till återförsäljare i USA]
		...
		ställa_V_Adjusting : V ; -- [STÄLLA OM] <Part>[telefonen]
		ställa_V2_Adjusting : V2 ; -- <Agent>[vi] kan [STÄLLA IN] <Feature>[temperatur]
		...
		pochera_V2_Apply_heat : V2 ; -- [ÅNGKOKA] <Food>[fisken] eller [POCHERA] ( <LU).>[sjuda]
		...
		ångkoka_V2_Apply_heat : V2 ; -- [ÅNGKOKA] <Food>[fisken] eller [POCHERA] ( <LU).>[sjuda]
		...
		göra_V2_Arranging : V2 ; -- <Agent>[kommunen] [GÖR I ORDNING] <Theme>[sitt nyköpta område]
		lägga_V2_Arranging : V2 ; -- <Agent>[Man] kan även [LÄGGA UPP] <Theme>[ett tak] <Configuration>[i form av en segelduk eller ett vackert parasoll]
		...
		smita_V_Arriving : V ; -- <Theme>[vi] [SMITER IN] <Goal>[på en krog där vi blir ensamma]
		...
		bränna_V2_Attaching : V2 ; -- <Agent>[man] [BRÄNNER FAST] <Item>[det]
		...
		haka_V2_Attaching : V2 ; -- <Agent>[Jag] släcker alla ljus , [HAKAR FAST] <Item>[fönstret]
		montera_V2_Attaching : V2 ; -- <Agent>[man] [MONTERAR] <Item>[bilbarnstolen]
		spika_V2_Attaching : V2 ; -- <Agent>[Vi] flyttade bort boden , rev bort masoniten och [SPIKADE FAST] <Item>[hattlist] <Goal>[på ytterväggarna]
		säkra_V2_Attaching : V2 ; -- <Agent>[man] [SÄKRAR] <Item>[sin last]
		koppla_V2_Attaching : V2 ; -- <Agent>[entreprenörerna Staffan Jonasson och Magnus Westin] på att [KOPPLA IHOP] <Items>[kablar]
		slå_V2_Attaching : V2 ; -- [SLÅ FAST] <Item>[ramarna] <Goal>[i den] <Connector>[med spik]
		dras_V2_Attaching : V2 ; -- <Item>[bogvisiret] [DRAS FAST] <Connector>[med vantskruvar] <Goal>[i durken]
		...
		ge_V2_Attack : V2 ; -- <Assailant>[Mannen] [GAV SIG PÅ] <Victim>[60-åringen]

		anstränga_V_Attempt : V ; -- <Agent>[Hon] [ANSTRÄNGER SIG] <Goal>[för att ta seden dit hon kommer]
		bjuda_V_Attempt : V ; -- <Agent>[vi] vågar [BJUDA TILL]
		anstränga_VV_Attempt : VV ; -- <Agent>[Dessa journalister] är professionella som [ANSTRÄNGER SIG] <Goal>[att varna allmänheten i sitt land , att kritisera korruptionen i regimen]
		...
		föreställa_VV_Awareness : VV ; -- <Content>[Att beta cellernas funktion haltar när genen för glukokinas muteras] kunde <Cognizer>[man] väl [FÖRESTÄLLA SIG]

		få_V_Be_in_agreement_on_assessment : V ; -- <Cognizer_1>[Grön Ungdom] [FÅR MEDHÅLL] <Cognizer_2>[av bland annat Mufaren Fredrik Axelsson]
		...
		hålla_V_Become_silent : V ; -- <Speaker>[du] [HÅLLA FLABBEN]
		tiga_V_Become_silent : V ; -- [TEG] <Speaker>[Johansson]

		göra_V_Becoming : V ; -- <Entity>[Föräldern] [GÖR SIG] <Final_state>[skyldig]
		utfalla_V_Becoming : V ; -- <Entity>[allt] har [UTFALLIT] <Final_state>[väl]

		ansluta_V_Becoming_a_member : V ; -- <Group>[Till deras lilla trupp] [ANSLUTER SIG] <New_member>[fler personer]
		...
		torka_V_Becoming_dry : V ; -- <Entity>[banan] [TORKADE UPP]

		dela_V_Becoming_separated : V ; -- <Whole>[kräftan] [DELAR SIG] <Parts>[i två halvor]
		smula_V_Becoming_separated : V ; -- <Whole>[Min grovhackade kycklingleverpaté] [SMULAR SIG]
		...
		hålla_V_Being_attached : V ; -- <Item>[dykparen] hela tiden [HÅLLER IHOP] <Goal>[med linan]
		...
		inringa_V2_Besieging : V2 ; -- [INRINGAR] <Assailant>[den kommunistiska gerillarörelsen Vietminh] <Victim>[den franska fästningen Dien Bien Phu]
		...
		göra_V_Bragging : V ; -- <Speaker>[blomman] slutade att [GÖRA SIG FIN]
		...
		andas_V2_Breathing : V2 ; -- <Air>[Vissa mediciner] [INHALERAS] , d.v.s [ANDAS IN]

		bära_V2_Bringing : V2 ; -- <Agent>[han] Cecilia och börjar sedan [BÄRA UPP] <Theme>[soppåsar med gamla blöjor]
		forsla_V2_Bringing : V2 ; -- <Agent>[De] [FORSLAR IN] <Theme>[militär utrustning]
		...
		sätta_V2_Building : V2 ; -- <Agent>[En smart student] kan [SÄTTA IHOP] <Created_entity>[en persondator]
		...
		ramla_V_Bungling : V ; -- <Agent>[tönten som] [RAMLAR RUNT]
		sjabbla_V2_Bungling : V2 ; -- <Patient>[Hallströms samer] [SJABBLAS BORT]
		...
		råka_V_Catastrophe : V ; -- <Undergoer>[hundarna] [RÅKA UT] <Undesirable_Event>[för en massa svansolyckor]
		...
		reda_V2_Cause_change_of_consistency : V2 ; -- [REDA UT] <Undergoer>[såsen]
		mjuka_V2_Cause_change_of_consistency : V2 ; -- <Undergoer,>[En mör filé med tilltalande vild smak] täckt av en generös driva ljuvliga kantareller i en mustig , konjaksspetsad sås , som [MJUKATS UPP]

		frysa_V2_Cause_change_of_phase : V2 ; -- <Agent>[Vi] kan [FRYSA NED] <Undergoer>[enkla organismer eller levande embryon ( foster i mycket tidigt stadium )] och [TINA UPP] <Undergoer>[dem]
		...
		tina_V2_Cause_change_of_phase : V2 ; -- <Agent>[Arkeologerna] för att [TINA UPP] <Undergoer>[tjälen]
		...
		skvalpa_V2_Cause_fluidic_motion : V2 ; -- <Agent>[prästen] som skred fram för att inte [SKVALPA UT] <Fluid>[den glittrande pölen]
		...
		daska_V2_Cause_harm : V2 ; -- <Agent>[han] [DASKADE TILL] <Victim>[henne]
		...
		klå_V2_Cause_harm : V2 ; -- <Agent>[han] skulle [KLÅ UPP] <Victim>[cykeltjuvar]
		...
		daska_V2_Cause_impact : V2 ; -- <Agent>[Ulf Jängnemyr som] [DASKADE TILL] <Impactee>[bollen]
		...
		skjuta_V2_Cause_motion : V2 ; -- <Agent>[Han] [SKÖT UT] <Theme>[sig]
		...
		fira_V2_Cause_motion : V2 ; -- <Agent>[De] [FIRADE NER] <Theme>[två plankor] <Goal>[till lagom höjd]
		...
		bunta_V2_Cause_to_amalgamate : V2 ; -- <Agent>[USA] har [BUNTAT IHOP] <Parts>[Irak , Iran och Nordkorea] <Whole>[till " ondskans axelmakter "]
		...
		fuska_V2_Cause_to_end : V2 ; -- <Agent>[hon] kan inte [FUSKA BORT] <Process>[timmar]
		arbeta_V2_Cause_to_end : V2 ; -- <Agent>[De] skall vara med och [ARBETA BORT] <State>[fattigdomen]
		lyfta_V2_Cause_to_end : V2 ; -- <Agent>[FN] [LYFTER] <State>[sanktionerna mot Irak]
		slå_V2_Cause_to_end : V2 ; -- <Agent>[Florence] [SLÅR UPP] <State>[sin förlovning med ' Stilton ']
		...
		bryta_V2_Cause_to_fragment : V2 ; -- [BRYTA AV] <Whole_patient>[skivan]
		paja_V2_Cause_to_fragment : V2 ; -- <Agent>[Han] [PAJAR] <Whole_patient>[rutor]
		slå_V2_Cause_to_fragment : V2 ; -- <Agent>[De] [SLOG IN] <Whole_patient>[ytterdörren]
		...
		starta_V2_Cause_to_resume : V2 ; -- <Agent>[jag] tänkt gå upp i vettig tid , [STARTA OM] <Process>[den biologiska klockan]
		...
		dö_V_Ceasing_to_be : V ; -- <Entity>[motorljudet] [DÖR BORT]
		försvinna_V_Ceasing_to_be : V ; -- <Entity>[Tre arbetsplatser] [FÖRSVINNER]
		gå_V_Ceasing_to_be : V ; -- <Entity>[Bensinen] bara [GÅR UPP I RÖK]
		...
		böja_V_Change_direction : V ; -- <Theme>[vinden] [BÖJER AV] <Direction>[mot öster] och { böjer av } <Direction>[åt väster]
		...
		ändra_V_Change_direction : V ; -- <Theme>[Han] [ÄNDRADE KURS]
		...
		vila_V_Change_event_time : V ; -- <Agent>[Sharon] valt att [VILA PÅ HANEN] <Event>[efter attacken]
		skjuta_V2_Change_event_time : V2 ; -- <Cause>[Regn] [SKÖT UPP] <Event>[första rundan]
		försena_V2_Change_event_time : V2 ; -- <Event>[humanitära insatser] avbryts eller [FÖRSENAS]

		gelea_V_Change_of_consistency : V ; -- <Undergoer>[det] ändå inte [GELEAR SIG]
		skära_V_Change_of_consistency : V ; -- <Undergoer>[såsen] [SKÄR SIG]
		...
		knäppa_V2_Change_operational_state : V2 ; -- <Agent>[Han] [KNÄPPTE PÅ] <Device>[bandspelaren]
		slå_V2_Change_operational_state : V2 ; -- <Agent>[Jag] [SLÅR PÅ] <Device>[teven]
		...
		luta_V_Change_posture : V ; -- <Protagonist>[Hans-Kristian Skaag på Föglö] [LUTA SIG]
		resa_V_Change_posture : V ; -- <Protagonist>[Peter] [RESTE SIG]
		sträcka_V_Change_posture : V ; -- <Protagonist>[ni] [STRÄCKER]
		stå_V_Change_posture : V ; -- <Protagonist>[folk] [STOD UPP]

		byta_V_Change_tool : V ; -- <Agent>[Finnlines] [BYTA] <New_tool>[till finsk flagga]
		gå_V_Change_tool : V ; -- <Agent>[Jag själv] [GICK ÖVER] <New_tool>[till epilering , som rycker ut stråt med flera minipincetter]

		slå_V_Chatting : V ; -- <Interlocutor_1>[ett gäng] [SLÅ SIG I SLANG] <Interlocutor_2>[med oss]
		...
		se_V2_Choosing : V2 ; -- <Cognizer>[Vi] har [SETT UT] <Chosen>[tre pristagare]
		...
		plocka_V2_Choosing : V2 ; -- <Chosen>[Tolv lyckliga] har [PLOCKATS UT]

		göra_V2_Claim_ownership : V2 ; -- <Claimant>[vetenskapen] inte [GÖR ANSPRÅK PÅ] <Property>[en slutgiltig sanning]
		muta_V2_Claim_ownership : V2 ; -- <Claimant>[Vi] måste [MUTA IN] <Property>[vårt revir]
		...
		fästa_V2_Closure : V2 ; -- [FÄST] [IHOP] <Containing_object>[degen]
		...
		stå_V_Collaboration : V ; -- <Partner_1>[polismästaren som hade kontor mitt emot kyrkan] [STOD I MASKOPI] <Partner_2>[med Forell]
		arbeta_V_Collaboration : V ; -- <Partners>[vi] får [ARBETA IHOP]

		stöta_V_Come_together : V ; -- <Party_1>[han] [STÖTTE SAMMAN] <Party_2>[med en och annan övrig udda existens]
		...
		lära_VV_Coming_to_believe : VV ; -- <Cognizer>[jag] har [LÄRT MIG] <Content>[att inte oroa mig för saker som inte inträffat än]

		designa_V2_Coming_up_with : V2 ; -- [DESIGNAR] <Cognizer>[hon] <Idea>[sina nya kollektioner]
		dikta_V2_Coming_up_with : V2 ; -- <Cognizer>[42-åringen] [DIKTADE IHOP] <Idea>[en historia om hur främlingar hade rusat in i lägenheten och skjutit]
		...
		kränga_V_Commerce_sell : V ; -- <Goods>[Prylarna som stjäls] är att [KRÄNGA AV]
		...
		svära_V_Commitment : V ; -- [SVÄR SIG] <Speaker>[bolaget] <Message>[fritt från ansvar]
		svära_VS_Commitment : VS ; -- <Speaker>[Jag] [SVÄR] <Addressee>[inför Gud] <Message>[att jag inte har gjort det]
		utfästa_VV_Commitment : VV ; -- <Speaker>[Börje Carlsson] ska [UTFÄSTA SIG] <Message>[att avstå från facklig verksamhet]
		...
		passa_V_Compatibility : V ; -- <Item_1>[föreställningarnas speltider] [PASSAR IHOP] <Item_2>[med skärgårdsfärjornas turlistor]
		...
		hålla_V_Compliance : V ; -- [HÅLLA SIG] <Norm>[till de bestämmelser som finns]
		...
		uppföra_V_Conduct : V ; -- <Agent>[hon] [UPPFÖR SIG] <Manner>[taktfullt] och <Manner>[diplomatiskt]
		...
		stå_V2_Confronting_problem : V2 ; -- <Agent>[vi] att [STÅ INFÖR] <Issue>[några väldigt allvarliga utmaningar]
		ta_V2_Confronting_problem : V2 ; -- <Agent>[jag] [TA UPP] <Issue>[problemet med Europaparlamentet]
		...
		ta_V2_Conquering : V2 ; -- <Conqueror>[judiska kolonister] [TOG I BESITTNING] <Theme>[fyra byggnader]
		...
		komma_V_Contingency : V ; -- <Outcome>[det marknära ozonet] [KOMMER AN] <Determinant>[på utsläpp av svaveloxid ( SOx ) och lättflyktiga kolväten ( CxHx )]

		känna_V_Contrition : V ; -- <Experiencer>[min faster] [KÄNNER SIG SKYLDIG] <Action>[för att hon inte gjorde något för att rädda sin bror]
		...
		laga_V2_Cooking_creation : V2 ; -- <Cook>[man] [LAGA TILL] <Produced_food>[en apelsinsaft]
		...
		måla_V2_Create_representation : V2 ; -- <Creator>[Jag] hade [MÅLAT AV] <Represented>[henne]
		...
		sätta_V2_Creating : V2 ; -- <Creator>[4 tjejer] [SÄTTER IHOP] <Created_entity>[ett lag]
		...
		klippa_V2_Cutting : V2 ; -- <Agent>[jag] [KLIPPA NER] <Item>[syrenhäcken]
		sönderdela_V2_Cutting : V2 ; -- [SÖNDERDELAR] <Item>[materialet]
		toppa_V2_Cutting : V2 ; -- <Agent>[Hon] skulle bara [TOPPA] <Item>[mitt långa hår]

		riva_V2_Damaging : V2 ; -- <Agent>[Israelerna] [RIVER] <Patient>[hus] eller [SKJUTER SÖNDER] <Patient>[dem]
		skjuta_V2_Damaging : V2 ; -- <Agent>[Israelerna] [RIVER] <Patient>[hus] eller [SKJUTER SÖNDER] <Patient>[dem]
		vandalisera_V2_Damaging : V2 ; -- <Agent>[Två killar] [VANDALISERAR] <Patient>[en bil]

		våga_V2_Daring : V2 ; -- <Agent>[Bush] [VÅGADE SIG PÅ] <Action>[en öppning mot Kuba]
		ta_VV_Daring : VV ; -- <Agent>[Båda parter] [TAR RISKEN] <Action>[att gå i en fälla]
		våga_VV_Daring : VV ; -- <Agent>[Upplands Väsby kommun] hade tillsammans med ABF [VÅGAT SIG PÅ] <Action>[att anordna ett utomhusarrangemang]

		avsomna_V_Death : V ; -- [AVSOMNADE] <Protagonist>[fru Emilia Petersen]
		bära_V_Death : V ; -- <Protagonist>[Mig] får de [BÄRA UT MED FÖTTERNA FÖRE]
		dö_V_Death : V ; -- <Protagonist>[Arten] [DOG UT]
		gå_V_Death : V ; -- <Protagonist>[Hans morfar] [GICK BORT]
		omkomma_V_Death : V ; -- <Protagonist>[En 65-årig man] [OMKOM]
		stryka_V_Death : V ; -- <Protagonist>[50 procent av nötväckorna] [STRYKER MED]
		...
		känna_V2_Desiring : V2 ; -- <Experiencer>[Jag] [KÄNNER FÖR] <Focal_participant>[en tur på landet]
		känna_VV_Desiring : VV ; -- <Experiencer>[Jag] [KÄNNER FÖR] <Event>[att skriva en bok själv]
		...
		demolera_V2_Destroying : V2 ; -- <Destroyer>[Israel] [DEMOLERAR] <Undergoer>[det palestinska jordbruket] och [ÖDELÄGGER] <Undergoer>[ekonomin]
		spränga_V2_Destroying : V2 ; -- <Destroyer>[Vi] [SPRÄNGER I LUFTEN] <Undergoer>[Berlin och Moskva]
		tillintetgöra_V2_Destroying : V2 ; -- <Destroyer>[de] kan [TILLINTETGÖRA] <Undergoer>[varandra]
		ödelägga_V2_Destroying : V2 ; -- <Destroyer>[Israel] [DEMOLERAR] <Undergoer>[det palestinska jordbruket] och [ÖDELÄGGER] <Undergoer>[ekonomin]
		jämna_V2_Destroying : V2 ; -- <Undergoer>[städerna Loren och Manatuto] hade [JÄMNATS MED MARKEN]

		kapa_V2_Detaching : V2 ; -- <Agent>[vi] [KAPAR AV] <Item>[benen] <Source>[på älgarna] <Time.>[innan vi dödar dom]
		...
		skiljas_V2_Differentiation : V2 ; -- <Phenomena>[lagen] [SKILJAS ÅT]

		beströ_V2_Dispersal : V2 ; -- [BESTRÖ] <Individuals>[de döda]
		sprida_V2_Dispersal : V2 ; -- <Agent>[Arrangerande Nilsby spelmän i Pargas] har också [SPRITT UT] <Individuals>[evenemangen]
		...
		klä_V_Dressing : V ; -- <Wearer>[Bea] [KLÄR SIG] <Clothing>[i moderna och utmanande kläder och högklackade skor]
		kostymera_V_Dressing : V ; -- <Wearer>[PSL-Klas] var inte ensam om att [KOSTYMERA SIG]
		skruda_V_Dressing : V ; -- <Wearer>[Förra årets studenter] fick [SKRUDA] [SIG]]
		sätta_V2_Dressing : V2 ; -- <Wearer>[Han] [SÄTTER PÅ SIG] <Clothing>[mössan]
		ta_V2_Dressing : V2 ; -- <Wearer>[De] [TAR PÅ SIG] lite mascara och <Clothing>[en snygg klänning]

		smita_V_Drop_in_on : V ; -- <Visitor>[jag] på att [SMITA IN]
		...
		gömma_V_Eclipse : V ; -- <Eclipsed>[solen] [GÖMMA SIG] <Obstruction>[bakom molnen]
		...
		lära_V2_Education_teaching : V2 ; -- <Teacher>[han] [LÄRDE UPP] <Student>[Tompa] <Role>[till telegrafoperatör]
		...
		lysa_V_Emanating : V ; -- <Emission>[Det] [LYSER] , nej , <Emission>[det] [STRÅLAR] <Source>[ur hennes ögon]
		...
		ge_V2_Emitting : V2 ; -- <Source_emitter>[en del plaster] kan [GE IFRÅN SIG] <Emission>[en bismak]
		...
		bekymra_V_Emotion_active : V ; -- <Experiencer>[En del akademiker] [BEKYMRAR SIG] <Topic>[över vad de ska forska i då disputationen är avklarad]
		oroa_V_Emotion_active : V ; -- <Experiencer>[De] [OROAR SIG] <Topic>[över sin situation]

		brinna_V_Emotion_heat : V ; -- <Experiencer>[Jag] [BRANN AV IVER]
		...
		avfrosta_V_Emptying : V ; -- [AVFROSTA] <Source>[bilens rutor]
		avlusa_V2_Emptying : V2 ; -- <Agent>[man] dessutom [AVLUSA] <Source>[kläderna]
		duka_V2_Emptying : V2 ; -- <Agent>[Servitörerna] [DUKADE AV] <Source>[de tomma borden]
		...
		avfrosta_V2_Emptying : V2 ; -- <Source>[bilrutorna] [AVFROSTAS]
		göra_V2_Emptying : V2 ; -- <Source>[cykelbanan som] [GJORDES REN] <Theme>[från snö]
		kalhugga_V2_Emptying : V2 ; -- <Source>[Skogar] [KALHUGGS]

		formulera_V_Encoding : V ; -- [FORMULERA MIG] <Manner>[försiktigt]
		...
		utsätta_V2_Endangering : V2 ; -- <Valued_entity>[de] kan [UTSÄTTAS FÖR FARA]
		...
		tvinga_V2_Enforcing : V2 ; -- <Agent>[studentgrupper] [TVINGAT FRAM] <Rule>[regler som hindrar universiteten från att investera sina pensionspengar i företag som är verksamma i Sudan utan en strategi för hur man ska hantera Darfur]

		förklara_V_Entering_of_plea : V ; -- <Accused>[Han] [FÖRKLARADE SIG] <Plea>[oskyldig] <Charges>[till anklagelserna]
		...
		komma_V_Evading : V ; -- <Evader>[Båda] lyckas [KOMMA UNDAN] <Pursuer>[från sin förföljare]
		gäcka_V2_Evading : V2 ; -- <Evader>[Själva rånarna] har dock [GÄCKAT] <Pursuer>[polisen]
		hålla_V2_Evading : V2 ; -- <Evader>[de] [HÖLL SIG UNDAN] <Pursuer>[förföljarna]
		komma_V2_Evading : V2 ; -- <Evader>[Han] [KOM UNDAN] <Pursuer>[överfallet]
		...
		slå_V_Experiencer_obj : V ; -- <Stimulus>[idén] [SLAGIT AN] <Experiencer>[på mig]
		...
		egga_V2_Experiencer_obj : V2 ; -- <Stimulus>[Hennes passivitet] [EGGADE UPP] <Experiencer>[honom]
		...
		hetsa_V2_Experiencer_obj : V2 ; -- <Stimulus>[Sådana händelser] [HETSAR UPP] <Experiencer>[folk]
		irritera_V2_Experiencer_obj : V2 ; -- <Stimulus>[en sådan skattehöjning] skulle [IRRITERA] <Experiencer>[människor]
		jaga_V2_Experiencer_obj : V2 ; -- <Stimulus>[Vi] [JAGAR UPP] <Experiencer>[varandra]
		...
		slå_V2_Experiencer_obj : V2 ; -- <Stimulus>[Men denna vetskap] räcker just då inte till för att [SLÅ NER] <Experiencer>[hans mod]
		...
		klä_V2_Expressing_publicly : V2 ; -- <Communicator>[Han] har [KLÄTT I ORD] <Content>[det jag känner om dagens samhälle och vad som är fel i det]
		...
		känna_V_Feeling : V ; -- <Experiencer>[Han] [KÄNNER SIG] <Emotional_state>[hotad]
		...
		julpynta_V2_Filling : V2 ; -- <Agent>[Han] [JULPYNTADE] <Goal>[hela lägenheten] men väntade med att [KLÄ] <Goal>[granen]
		klä_V2_Filling : V2 ; -- <Agent>[Han] [JULPYNTADE] <Goal>[hela lägenheten] men väntade med att [KLÄ] <Goal>[granen]
		slå_V2_Filling : V2 ; -- <Agent>[De] skall [SLÅ IN] <Goal>[en flaska] <Theme>[i julklappspapper]
		...
		säga_V2_Firing : V2 ; -- <Employer>[hans statligt drivna företag , som] [SADE UPP] <Employee>[honom]

		skena_V_Fleeing : V ; -- <Self_mover>[Två ystra hästar från Lannäslunds skolor i Jakobstad] [SKENADE] <Goal>[mot en hägrande frihet]
		smita_V_Fleeing : V ; -- <Self_mover>[Hon] sätter eld på Snapes mantel och lyckas [SMITA IVÄG]
		fly_V_Fleeing : V ; -- <Source>[Från Sarajevo] [FLYDDE] <Self_mover>[människor] <Path>[i tunnlar]

		sippra_V_Fluidic_motion : V ; -- <Fluid>[vätskan] <Area>[i svampen] [SIPPRAT UR]
		...
		flyta_V_Fluidic_motion : V ; -- <Fluid>[blodet] [FLYTER FRAM] <Path>[i navelsträngen] och <Path>[i fostrets blodådror]
		...
		ha_V2_Forging : V2 ; -- <Agent>[Sambon] [HADE FÖRFALSKAT] <Forgery>[hennes namnteckning]

		avstå_V_Forgoing : V ; -- <Forgoer>[Jag] kommer att [AVSTÅ] <Desirable>[från att rösta]
		låta_VV_Forgoing : VV ; -- <Forgoer>[Man] har slösat med tillgängliga resurser och [LÅTIT BLI] <Desirable>[att hjälpa fattiga länder]
		...
		göra_V_Forming_relationships : V ; -- <Partner_1>[Min kille] [GJORDE SLUT]
		...
		dra_V2_Gathering_up : V2 ; -- <Agent>[jag] ska försöka [DRA IHOP] <Aggregate>[ett gäng]
		...
		båda_V2_Gathering_up : V2 ; -- <Agent>[Myndigheten] och [BÅDADE UPP] <Individuals>[såna gubbar som en gång hade bestrålat ungdomen med sin bildning]
		föra_V2_Gathering_up : V2 ; -- <Agent>[hon] skulle [FÖRA IHOP] <Individuals>[Johan med Peter]
		kalla_V2_Gathering_up : V2 ; -- <Agent>[Han] skyndade till sitt rum för att [KALLA IHOP] <Individuals>[sina kollegor]
		...
		skaffa_V2_Getting : V2 ; -- <Recipient>[vi] [SKAFFAR FRAM] <Theme>[medel]
		säkra_V2_Getting : V2 ; -- <Recipient>[partiet] har [SÄKRAT] <Theme>[ett mandat]

		köra_V2_Getting_vehicle_underway : V2 ; -- <Driver>[Vi] [KÖRDE UT] <Vehicle>[båten]
		...
		fälla_V_Go_into_shape : V ; -- <Theme>[Blommorna som] vecklar ut sig i sol och [FÄLLER IHOP SIG]
		krusa_V_Go_into_shape : V ; -- <Theme>[Vattnet] [KRUSAR SIG]
		kröka_V_Go_into_shape : V ; -- <Theme>[Den djupa bukten som] [KRÖKER SIG]
		locka_V_Go_into_shape : V ; -- <Theme>[Det svarta håret] [LOCKADE SIG]
		rulla_V_Go_into_shape : V ; -- <Theme>[det kloka djuret] svarade inte , gav mig bara ett överseende ögonkast och [RULLADE IHOP SIG]
		räta_V_Go_into_shape : V ; -- <Theme>[Ryggen] [RÄTADE SIG]
		vika_V_Go_into_shape : V ; -- <Theme>[Han] [VIKER IHOP SIG]
		...
		smula_V2_Grinding : V2 ; -- <Grinder>[Hon] [SMULAR SÖNDER] <Undergoer>[askan]

		rengöra_V_Grooming : V ; -- [RENGÖR] <Body_part>[ansikte] och <Body_part>[hals] och undvik att [SKRUBBA]
		skrubba_V_Grooming : V ; -- [RENGÖR] <Body_part>[ansikte] och <Body_part>[hals] och undvik att [SKRUBBA]
		borsta_V2_Grooming : V2 ; -- <Agent>[Liam] [BORSTAR] <Body_part>[tänderna]
		sprita_V2_Grooming : V2 ; -- [TVÄTTA] <Body_part>[händerna] , [SPRITA]
		tvätta_V2_Grooming : V2 ; -- [TVÄTTA] <Body_part>[händerna] , [SPRITA]
		två_V2_Grooming : V2 ; -- <Agent>[Jag] [TVÅR] <Body_part>[mina händer]

		göra_V_Halt : V ; -- <Theme>[Gaffeln med tomatbiten] [GÖR HALT]
		stanna_V_Halt : V ; -- <Theme>[den enda som] [STANNAR UPP]
		...
		plöja_V_Impact : V ; -- <Impactor>[det] [PLÖJDE IN] <Impactee>[i en bil]
		...
		peka_V2_Indicating : V2 ; -- <Communicator>[hon] inte [PEKA UT] <Unresolved_referent>[någon favoritchoklad]
		...
		hugga_V_Ingestion : V ; -- <Ingestor>[Annie Wegelius] [HUGGER IN] <Ingestibles>[på en korv med bröd]
		...
		hålla_V2_Inhibit_movement : V2 ; -- <Agent>[Han] [HÖLL FAST] <Theme>[honom]
		...
		slå_V2_Killing : V2 ; -- <Killer>[En tjänare] och [SLOG IHJÄL] <Victim>[honom]
		...
		bli_V2_Losing : V2 ; -- <Owner>[kommunisterna] [BLIVIT AV MED] <Possession>[makten]
		tappa_V2_Losing : V2 ; -- <Owner>[jag] [TAPPADE BORT] <Possession>[all min mail]

		mala_V_Make_noise : V ; -- <Noisy_event>[Höstens remissdebatt 1967] [MALDE PÅ]
		...
		ta_V2_Manufacturing : V2 ; -- [TAR FRAM] <Product>[nya proteser som är individanpassade för patienterna och som gör att läkningen går snabbare]
		tillverka_V2_Manufacturing : V2 ; -- [TILLVERKA] <Product>[ett relä]

		bre_V_Mass_motion : V ; -- <Mass_theme>[Klätterhortensian] [BREDER UT SIG] <Area.>[över husväggen]
		sprida_V_Mass_motion : V ; -- <Mass_theme>[Tjänstemän från Internationella valutafonden IMF] anlände till landet och [SPRED UT SIG] <Area.>[över huvudstaden]
		välla_V_Mass_motion : V ; -- <Mass_theme>[Cyklisterna] [VÄLLER FRAM]
		tränga_V_Mass_motion : V ; -- <Mass_theme>[En del folk] börjar [TRÄNGA SIG] <Direction>[mot dörrarna]
		...
		komma_V2_Memory : V2 ; -- <Cognizer>[folk] kan [KOMMA IHÅG] <Content>[ett namn som Schwarzenegger]
		...
		slå_V_Motion_directional : V ; -- <Theme>[Hon] bråkade , stegrade sig och [SLOG ÖVER]
		stiga_V_Motion_directional : V ; -- <Theme>[Vattnet] [STEG UPP]
		...
		sno_V_Moving_in_place : V ; -- <Theme>[Hon] [SNODDE RUNT]
		...
		visa_V_Obviousness : V ; -- <Phenomenon>[Solen] [VISAR SIG]
		...
		köra_V2_Operate_vehicle : V2 ; -- <Driver>[Folk] [KÖR] <Vehicle>[båt] som <Driver>[de] [KÖR] <Vehicle>[bil]
		...
		tycka_V_Others_situation_as_stimulus : V ; -- <Experiencer>[En av campingägarna] [TYCKER SYND] <Other>[om Sune]
		känna_V2_Others_situation_as_stimulus : V2 ; -- <Experiencer>[man] blir glad av deras framgångar och [KÄNNER MED] <Other>[dem]
		...
		röra_V_Participation : V ; -- <Participant_1>[Thomas] [RÖRDE SIG]

		stiga_V_Path_shape : V ; -- <Road>[vägen] [STIGER] och [SVÄNGER] <Direction>[mot höger]
		svänga_V_Path_shape : V ; -- <Road>[vägen] [STIGER] och [SVÄNGER] <Direction>[mot höger]
		...
		ha_V_Personal_relationship : V ; -- <Partner_1>[Hon] [HAR IHOP DET] <Partner_2>[med en av de utbildade kirurgerna på sjukhuset - Derek Shepherd ( även kallad McDreamy )]
		...
		ge_V_Place_weight_on : V ; -- [GE TYNGD] <Consideration>[åt vissa politiska krav]
		lägga_V_Place_weight_on : V ; -- <Agent>[vi] försöker [LÄGGA TYNGDEN] <Consideration>[på att barnen själva skall synas i rutan]
		...
		tvinga_V2_Placing : V2 ; -- <Agent>[Man] skall aldrig försöka [TVINGA NED] <Theme>[något] <Goal>[i munnen på en medvetslös person]
		...
		sätta_V_Posture : V ; -- <Agent>[Jag] måste [SÄTTA MIG UPP]

		repa_V_Practice : V ; -- <Action>[över 25 melodier som] <Agent>[vi] [REPADE IN]
		repetera_V_Practice : V ; -- <Agent>[han] [REPETERAT]
		öva_V_Practice : V ; -- <Agent>[jag] förresten [ÖVA] <Action>[på arior för mezzosopran]
		repa_V2_Practice : V2 ; -- <Agent>[Vi] hade [REPAT IN] <Action>[l2 låtar]
		träna_V2_Practice : V2 ; -- <Agent>[jag] istället [TRÄNA] <Action>[cirkelträning]
		öva_V2_Practice : V2 ; -- <Action>[schlagersånger som] <Agent>[de] [ÖVAT IN] <Occasion>[för skolmusikfestivalen]
		...
		lägga_V2_Preserving : V2 ; -- <Agent>[du] [LÄGGER IN] <Undergoer>[sill] <Medium>[i klar lag]
		sylta_V2_Preserving : V2 ; -- <Agent>[man] [SYLTADE IN] <Undergoer>[dom]
		...
		gå_V_Process_continue : V ; -- <Event>[Livet] [GICK SIN GILLA GÅNG]
		hålla_V_Process_continue : V ; -- <Event>[Värmen] [HÅLLER I SIG]
		...
		ta_V_Process_end : V ; -- <Process>[det kalla kriget] [TOG SLUT]
		...
		bryta_V_Process_start : V ; -- <Event>[En brand] [BRYTER UT]
		...
		sätta_V_Process_start : V ; -- <Event>[kurortsverksamheten] [SATTE FART]

		avstanna_V_Process_stop : V ; -- <Process>[byggandet] har [AVSTANNAT]
		stanna_V_Process_stop : V ; -- <Process>[bostadsbyggandet] [STANNAR AV]
		...
		gå_V_Proliferating_in_number : V ; -- <Set>[moderaterna] [GÅR NER] <Initial_number>[från 23,8] <Final_number>[till 21,9]
		...
		säga_V_Quitting : V ; -- <Employee>[Emma] [SA UPP SIG] <Position>[från sitt jobb som florist]

		dra_V_Quitting_a_place : V ; -- <Self_mover>[Gaddafistyrkorna] [DRAGIT SIG TILLBAKA] <Source>[från staden]
		dunsta_V_Quitting_a_place : V ; -- <Self_mover>[du] [DUNSTAR]
		fly_V_Quitting_a_place : V ; -- <Self_mover>[Huvudpersonen själv] har [FLYTT FÄLTET]
		...
		skumma_V2_Reading : V2 ; -- <Reader>[åklagaren] [SKUMMADE IGENOM] <Text>[domen]
		sluka_V2_Reading : V2 ; -- <Reader>[miljoner människor] [SLUKAR] <Text>[böcker]
		ögna_V2_Reading : V2 ; -- <Reader>[jag] kunde få [ÖGNA IGENOM] <Text>[texten]

		diktera_V2_Reading_aloud : V2 ; -- <Speaker>[Pippi] [DIKTERAR] <Text>[ett brev]
		läsa_V2_Reading_aloud : V2 ; -- <Text>[ett brev] från som <Speaker>[jag] gärna skulle vilja [LÄSA UPP]
		...
		ta_V2_Receiving : V2 ; -- <Recipient>[Nobelpristagarna] kommer till för att [TA EMOT] <Theme>[sina medaljer]
		...
		komma_V_Recovery : V ; -- <Patient>[Han] [KOM SIG]
		återhämta_V_Recovery : V ; -- <Patient>[Räven] har [ÅTERHÄMTAT SIG] <Affliction>[efter skabben]
		...
		dirigera_V2_Redirecting : V2 ; -- <Theme>[några mångmiljonbelopp] kan [DIRIGERAS OM] <Goal>[till just Stockholm]
		styra_V2_Redirecting : V2 ; -- <Theme>[Huvuduppdraget] [STYRDES OM] <Goal>[till ett konkret mål : att förmedla jobb]

		se_V2_Reference_text : V2 ; -- [SE ÄVEN] <Source_of_information).>[hans Djävulssonaten]
		...
		sätta_V2_Relating_concepts : V2 ; -- <Concept_1>[alla brott] måste också [SÄTTAS I RELATION] <Concept_2>[till det uppdrag man har]

		dra_V_Relative_time : V ; -- <Focal_occasion>[Lektionen] [DRAR UT PÅ TIDEN]
		...
		bli_V_Remainder : V ; -- <Remainder>[Alla pengar som] [BLIR ÖVER]
		...
		komma_VV_Remembering_to_do : VV ; -- [KOM IHÅG] <Action>[att inte fastna i detaljer]

		göra_V_Removing : V ; -- <Agent>[Besökarna] kunde inte [GÖRA SIG AV] <Theme>[med avfallet]
		tömma_V2_Removing : V2 ; -- <Agent>[Rånarna] [TÖMDE] <Source>[kassaskåpet]
		plocka_V2_Removing : V2 ; -- <Agent>[hon] [PLOCKAR] <Theme>[en kyckling]
		slå_V2_Removing : V2 ; -- [SLÅ BORT] <Theme>[vattnet]
		vräka_V2_Removing : V2 ; -- <Agent>[Hyresvärden] vill [VRÄKA] <Theme>[nazisterna]
		kränga_V3_Removing : V3 ; -- [KRÄNGA AV] <Source>[sig] <Theme>[sina fuktiga badbrallor]
		...
		ta_V2_Render_nonfunctional : V2 ; -- <Agent>[man] [TAR SÖNDER] <Artifact>[alla klockor]

		hyra_V2_Renting : V2 ; -- <Lessee>[31 firmor] [HYR] <Goods>[rum]

		arrendera_V2_Renting_out : V2 ; -- <Lessor>[Kommunen] [ARRENDERAR UT] <Goods>[ett stort antal gårdar] <Lessee.>[till djurägare]
		hyra_V2_Renting_out : V2 ; -- <Lessor>[Garantiföreningen] [HYR UT] <Goods>[husen] <Lessee>[till sju olika aktörer]

		avsäga_V2_Renunciation : V2 ; -- <Speaker>[en av de som] [AVSADE SIG] <Content>[sin kandidatur]
		ge_V2_Renunciation : V2 ; -- <Speaker>[vi] ska [GE UPP] <Content>[vår egenart]

		stå_V2_Repel : V2 ; -- <Defender>[stenhusen] [STOD EMOT] <Enemy>[projektilerna]

		byta_V2_Replacing : V2 ; -- <Agent>[Jag] beslöt [BYTA UT] <Old>[kameran] <New>[mot penseln] och <Old>[filmen] <New>[mot papper]
		...
		kalla_V2_Request : V2 ; -- <Addressee>[Stornaways båt] [KALLADES UT] <Message.>[för att hjälpa en tankbåt som hade problem utanför Cape Wrath]
		...
		komma_V_Resolve_problem : V ; -- <Circumstances:>[Detta vill jag att Reinfeldt svarar på] Hur ska <Agent>[vi] [KOMMA TILL RÄTTA] <Problem>[med arbetslösheten]
		...
		klara_V2_Resolve_problem : V2 ; -- <Agent>[poliserna] på att [KLARA UPP] <Problem>[inbrott och stölder]
		...
		komma_V_Rising_to_a_challenge : V ; -- <Protagonist>[jag] gärna [KOMMA I KAPP] <Activity>[med lektionerna]
		...
		vara_V_Rotting : V ; -- <Undergoer>[såren] [VARAR SIG]
		...
		leta_V2_Scouring : V2 ; -- <Searcher>[poliserna] [LETADE IGENOM] <Ground>[hans bostad]
		...
		röra_V_Self_motion : V ; -- <Self_mover>[Han] får dock [RÖRA SIG]
		...
		stiga_V_Self_motion : V ; -- <Self_mover>[Värden] [STIGER FRAM] <Goal>[till hans bord]
		störta_V_Self_motion : V ; -- [STÖRTADE] <Self_mover>[han] <Goal>[ut på gatan]

		dirigera_V2_Sending : V2 ; -- <Sender>[Polis och brandkår] och [DIRIGERADE OM] <Theme>[trafiken]
		...
		spalta_V2_Separating : V2 ; -- <Whole>[Riskfaktorn] kan i sin tur , menar Justin Jenk , [SPALTAS UPP] <Parts>[i två dimensioner]

		blossa_V_Setting_fire : V ; -- <Flammables>[Restaurangen] [BLOSSAT UPP]
		...
		bryta_V_Setting_out : V ; -- <Self_mover>[jag] [BRÖT UPP]
		sätta_V_Setting_out : V ; -- <Self_mover>[Jag] [SÄTTER AV]

		avfyra_V2_Shoot_projectiles : V2 ; -- <Agent>[Polisen] svarade med att [AVFYRA] <Projectile>[tårgas] och <Projectile>[gummikulor]
		bränna_V2_Shoot_projectiles : V2 ; -- <Agent>[man] [BRÄNNER AV] <Projectile>[nödraketer]
		skjuta_V2_Shoot_projectiles : V2 ; -- <Agent>[Du] [SKJUTER IVÄG] <Projectile>[fyrverkerier]

		gå_V_Sidereal_appearance : V ; -- <Astronomical_entity>[solen] [GÅR NED]
		sjunka_V_Sidereal_appearance : V ; -- <Astronomical_entity>[månen] [STEG UPP] ännu innan en <Astronomical_entity>[solnedgång] hade [SJUNKIT] <Place.>[på den andra { sidan himlavalvet }]
		stiga_V_Sidereal_appearance : V ; -- <Astronomical_entity>[Månen] [STIGER]

		skriva_V2_Sign_agreement : V2 ; -- <Signatory>[De 19 passagerarna och besättningen] [SKRIVER UNDER] <Agreement>[deportationshandlingar]

		hyssja_V2_Silencing : V2 ; -- <Agent>[En annan] [HYSSJAR NER] <Speaker>[sin baby som har börjat tröttna]
		...
		smuggla_V2_Smuggling : V2 ; -- <Perpetrator>[hon] [SMUGGLAT IN] <Goods>[en mobiltelefon som en av fångarna skulle använda]
		...
		lämna_V2_Submitting_documents : V2 ; -- <Submittor>[Jag] har [LÄMNAT IN] <Documents>[en hemtenta om Gustav Vasas brev]
		skicka_V2_Submitting_documents : V2 ; -- <Submittor>[Sveriges kommuner och landsting] har [SKICKAT IN] <Documents>[en skrivelse] <Authority>[till socialdepartementet]
		sända_V2_Submitting_documents : V2 ; -- <Submittor>[Vi] har [SÄNT IN] <Documents>[våra brev] <Authority>[till arrangörerna]

		bita_V_Success_or_failure : V ; -- <Agent>[Han] fick [BITA I GRÄSET]
		göra_V_Success_or_failure : V ; -- <Agent>[Jag] kommer att [GÖRA BORT MIG]
		...
		göra_V_Successful_action : V ; -- <Instrument>[En nypa socker] [GÖR SUSEN]
		gå_V_Successful_action : V ; -- <Means>[Allt] [GÅR BRA]
		slå_V_Successful_action : V ; -- <Means>[Skördar som] [SLOG FEL]
		...
		överlämna_V_Surrendering : V ; -- <Fugitive>[De flesta av de upproriska soldaterna] [ÖVERLÄMNADE SIG] <Authorities>[till de pakistanska myndigheterna]

		lämna_V2_Surrendering_possession : V2 ; -- <Surrenderer>[Chauffören] [LÄMNADE IFRÅN SIG] <Theme>[pengarna]
		...
		sova_V_Temporary_stay : V ; -- <Guest>[Issa] [SOV ÖVER] <Host>[hos mig]
		bo_V_Temporary_stay : V ; -- <Guest>[Jag] [BOR] <Location>[på hotell Örnsköld bakom Dramaten i en liten hytt utan fönster]

		komma_V_Text_creation : V ; -- <Author>[Så kallat enklare folk] får sällan [KOMMA TILL TALS]
		...
		slå_V_Undergo_change : V ; -- <Entity>[signalen] [SLÅR OM]
		...
		underkasta_V2_Undergoing : V2 ; -- <Entity>[han] grips och får [UNDERKASTA SIG] <Event>[provtagning]

		avklä_V2_Undressing : V2 ; -- <Wearer>[Man] [AVKLÄDDE] <Clothing>[allt]
		dra_V2_Undressing : V2 ; -- <Wearer>[Hon] [DRAR AV SIG] <Clothing>[mössan]
		sparka_V2_Undressing : V2 ; -- <Wearer>[Han] [TOG AV SIG] <Clothing>[sin kavaj] , [SPARKA AV SIG] båda <Clothing>[skorna]
		ta_V2_Undressing : V2 ; -- <Wearer>[Han] [TOG AV SIG] <Clothing>[sin kavaj] , [SPARKA AV SIG] båda <Clothing>[skorna]
		...
		ta_V2_Using : V2 ; -- <Agent>[Forskare i USA] vill [TA TILL] <Instrument>[drastiska medicinska åtgärder] <Purpose>[för att få bukt med fetmaepidemin]
		...
		tas_V2_Using : V2 ; -- <Instrument>[Säve flygplats] [TAS I ANSPRÅK]

		finna_V2_Verdict : V2 ; -- <Judge>[Tingsrätten] [FINNER] <Defendant>[honom] <Finding>[skyldig på samtliga åtalspunkter]

		slå_VS_Wagering : VS ; -- <Gambler>[Jag] kan [SLÅ VAD] <Outcome>[om att Häckens 16-årige Dulee Johnsson har bättre teknik än alla damer i hela Sverige]
		...
		ta_V2_Win_prize : V2 ; -- [TA HEM] <Prize>[bucklan]

		dra_V_Withdraw_from_participation : V ; -- <Participant>[en överförmyndare] [DRAR SIG TILLBAKA]
