...
oper
	...
	divide_V = mkV (ridere_74 "dividere")  ;
	...
	evaluate_V2 = mkV2 "valutare"  ;  -- uhmm maybe calcolare
...
oper
	add_V3 = dirV3 (mkV "sommare") to_Prep  ;
        assume_VS = mkVS IR.supporre_V ;  
	...
	multiply_V3 = dirV3 (mkV "multiplicare") by_Prep  ;
	prove_VS = mkVS prove_V  ;
	show_VS = mkVS show_V  ;
	subtract_V3 = dirV3 IR.sottrarre_V from_Prep  ;
...
oper
	...
	union_Conj    = {s1 = [] ; s2 = "unito" ; n = CR.Sg} ;     		-- l'unione di x ed y
	minus_Conj    = {s1 = [] ; s2 = "meno" ; n = CR.Sg} ; 		-- la differenza x meno y
