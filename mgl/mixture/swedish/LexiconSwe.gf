...
instance LexiconSwe of Lexicon =  LexiconX - [select_V3, sub, squareroot_CN]
with
	(Syntax = SyntaxSwe), 
...
oper
	...
	exponential_N = mkN "exponent" "exponenter" ;
...
oper
	...
	prefixN :  Str -> N -> N	= \arc,sin -> {s= \\n,sp,c => (arc + sin.s!n!sp!c) ; g= sin.g ; lock_N=<>} ;
	dos = n2_Numeral ;
